...
},$scope.$on("$destroy",function(){for(;watchers.length;)watchers.shift()()})}]).directive("uibTimepicker",["uibTimepickerConfig",function(uibTimepickerConfig){return{require:["uibTimepicker","?^ngModel"],controller:"UibTimepickerController",controllerAs:"timepicker",replace:!0,scope:{},templateUrl:function(element,attrs){return attrs.templateUrl||uibTimepickerConfig.templateUrl},link:function(scope,element,attrs,ctrls){var timepickerCtrl=ctrls[0],ngModelCtrl=ctrls[1];ngModelCtrl&&timepickerCtrl.init(ngModelCtrl,element.find("input"))}}}]),angular.module("ui.bootstrap.typeahead",["ui.bootstrap.debounce","ui.bootstrap.position"]).factory("uibTypeaheadParser",["$parse",function($parse){var TYPEAHEAD_REGEXP=/^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w\d]*))\s+in\s+([\s\S]+?)$/;return{parse:function(input){var match=input.match(TYPEAHEAD_REGEXP);if(!match)throw new Error('Expected typeahead specification in form of "_modelValue_ (as _label_)? for _item_ in _collection_" but got "'+input+'".');return{itemName:match[3],source:$parse(match[4]),viewMapper:$parse(match[2]||match[1]),modelMapper:$parse(match[1])}}}}]).controller("UibTypeaheadController",["$scope","$element","$attrs","$compile","$parse","$q","$timeout","$document","$window","$rootScope","$$debounce","$uibPosition","uibTypeaheadParser",function(originalScope,element,attrs,$compile,$parse,$q,$timeout,$document,$window,$rootScope,$$debounce,$position,typeaheadParser){function fireRecalculating(){scope.moveInProgress||(scope.moveInProgress=!0,scope.$digest()),debouncedRecalculate()}function recalculatePosition(){scope.position=appendToBody?$position.offset(element):$position.position(element),scope.position.top+=element.prop("offsetHeight")}var modelCtrl,ngModelOptions,HOT_KEYS=[9,13,27,38,40],eventDebounceTime=200,minLength=originalScope.$eval(attrs.typeaheadMinLength);minLength||0===minLength||(minLength=1);var waitTime=originalScope.$eval(attrs.typeaheadWaitMs)||0,isEditable=originalScope.$eval(attrs.typeaheadEditable)!==!1;originalScope.$watch(attrs.typeaheadEditable,function(newVal){isEditable=newVal!==!1});var hasFocus,selected,isLoadingSetter=$parse(attrs.typeaheadLoading).assign||angular.noop,onSelectCallback=$parse(attrs.typeaheadOnSelect),isSelectOnBlur=angular.isDefined(attrs.typeaheadSelectOnBlur)?originalScope.$eval(attrs.typeaheadSelectOnBlur):!1,isNoResultsSetter=$parse(attrs.typeaheadNoResults).assign||angular.noop,inputFormatter=attrs.typeaheadInputFormatter?$parse(attrs.typeaheadInputFormatter):void 0,appendToBody=attrs.typeaheadAppendToBody?originalScope.$eval(attrs.typeaheadAppendToBody):!1,appendTo=attrs.typeaheadAppendTo?originalScope.$eval(attrs.typeaheadAppendTo):null,focusFirst=originalScope.$eval(attrs.typeaheadFocusFirst)!==!1,selectOnExact=attrs.typeaheadSelectOnExact?originalScope.$eval(attrs.typeaheadSelectOnExact):!1,isOpenSetter=$parse(attrs.typeaheadIsOpen).assign||angular.noop,showHint=originalScope.$eval(attrs.typeaheadShowHint)||!1,parsedModel=$parse(attrs.ngModel),invokeModelSetter=$parse(attrs.ngModel+"($$$p)"),$setModelValue=function(scope,newValue){return angular.isFunction(parsedModel(originalScope))&&ngModelOptions&&ngModelOptions.$options&&ngModelOptions.$options.getterSetter?invokeModelSetter(scope,{$$$p:newValue}):parsedModel.assign(scope,newValue)},parserResult=typeaheadParser.parse(attrs.uibTypeahead),scope=originalScope.$new(),offDestroy=originalScope.$on("$destroy",function(){scope.$destroy()});scope.$on("$destroy",offDestroy);var popupId="typeahead-"+scope.$id+"-"+Math.floor(1e4*Math.random());element.attr({"aria-autocomplete":"list","aria-expanded":!1,"aria-owns":popupId});var inputsContainer,hintInputElem;showHint&&(inputsContainer=angular.element("<div></div>"),inputsContainer.css("position","relative"),element.after(inputsContainer),hintInputElem=element.clone(),hintInputElem.attr("placeholder",""),hintInputElem.val(""),hintInputElem.css({position:"absolute",top:"0px",left:"0px","border-color":"transparent","box-shadow":"none",opacity:1,background:"none 0% 0% / auto repeat scroll padding-box border-box rgb(255, 255, 255)",color:"#999"}),element.css({position:"relative","vertical-align":"top","background-color":"transparent"}),inputsContainer.append(hintInputElem),hintInputElem.after(element));var popUpEl=angular.element("<div uib-typeahead-popup></div>");popUpEl.attr({id:popupId,matches:"matches",active:"activeIdx",select:"select(activeIdx, evt)","move-in-progress":"moveInProgress",query:"query",position:"position","assign-is-open":"assignIsOpen(isOpen)",debounce:"debounceUpdate"}),angular.isDefined(attrs.typeaheadTemplateUrl)&&popUpEl.attr("template-url",attrs.typeaheadTemplateUrl),angular.isDefined(attrs.typeaheadPopupTemplateUrl)&&popUpEl.attr("popup-template-url",attrs.typeaheadPopupTemplateUrl);var resetHint=function(){showHint&&hintInputElem.val("")},resetMatches=function(){scope.matches=[],scope.activeIdx=-1,element.attr("aria-expanded",!1),resetHint()},getMatchId=function(index){return popupId+"-option-"+index};scope.$watch("activeIdx",function(index){0>index?element.removeAttr("aria-activedescendant"):element.attr("aria-activedescendant",getMatchId(index))});var inputIsExactMatch=function(inputValue,index){return scope.matches.length>index&&inputValue?inputValue.toUpperCase()===scope.matches[index].label.toUpperCase():!1},getMatchesAsync=function(inputValue,evt){var locals={$viewValue:inputValue};isLoadingSetter(originalScope,!0),isNoResultsSetter(originalScope,!1),$q.when(parserResult.source(originalScope,locals)).then(function(matches){var onCurrentRequest=inputValue===modelCtrl.$viewValue;if(onCurrentRequest&&hasFocus)if(matches&&matches.length>0){scope.activeIdx=focusFirst?0:-1,isNoResultsSetter(originalScope,!1),scope.matches.length=0;for(var i=0;i<matches.length;i++)locals[parserResult.itemName]=matches[i],scope.matches.push({id:getMatchId(i),label:parserResult.viewMapper(scope,locals),model:matches[i]});if(scope.query=inputValue,recalculatePosition(),element.attr("aria-expanded",!0),selectOnExact&&1===scope.matches.length&&inputIsExactMatch(inputValue,0)&&(angular.isNumber(scope.debounceUpdate)||angular.isObject(scope.debounceUpdate)?$$debounce(function(){scope.select(0,evt)},angular.isNumber(scope.debounceUpdate)?scope.debounceUpdate:scope.debounceUpdate["default"]):scope.select(0,evt)),showHint){var firstLabel=scope.matches[0].label;angular.isString(inputValue)&&inputValue.length>0&&firstLabel.slice(0,inputValue.length).toUpperCase()===inputValue.toUpperCase()?hintInputElem.val(inputValue+firstLabel.slice(inputValue.length)):hintInputElem.val("")}}else resetMatches(),isNoResultsSetter(originalScope,!0);onCurrentRequest&&isLoadingSetter(originalScope,!1)},function(){resetMatches(),isLoadingSetter(originalScope,!1),isNoResultsSetter(originalScope,!0)})};appendToBody&&(angular.element($window).on("resize",fireRecalculating),$document.find("body").on("scroll",fireRecalculating));var debouncedRecalculate=$$debounce(function(){scope.matches.length&&recalculatePosition(),scope.moveInProgress=!1},eventDebounceTime);scope.moveInProgress=!1,scope.query=void 0;var timeoutPromise,scheduleSearchWithTimeout=function(inputValue){timeoutPromise=$timeout(function(){getMatchesAsync(inputValue)},waitTime)},cancelPreviousTimeout=function(){timeoutPromise&&$timeout.cancel(timeoutPromise)};resetMatches(),scope.assignIsOpen=function(isOpen){isOpenSetter(originalScope,isOpen)},scope.select=function(activeIdx,evt){var model,item,locals={};selected=!0,locals[parserResult.itemName]=item=scope.matches[activeIdx].model,model=parserResult.modelMapper(originalScope,locals),$setModelValue(originalScope,model),modelCtrl.$setValidity("editable",!0),modelCtrl.$setValidity("parse",!0),onSelectCallback(originalScope,{$item:item,$model:model,$label:parserResult.viewMapper(originalScope,locals),$event:evt}),resetMatches(),scope.$eval(attrs.typeaheadFocusOnSelect)!==!1&&$timeout(function(){element[0].focus()},0,!1)},element.on("keydown",function(evt){if(0!==scope.matches.length&&-1!==HOT_KEYS.indexOf(evt.which)){if(-1===scope.activeIdx&&(9===evt.which||13===evt.which))return resetMatches(),void scope.$digest();evt.preventDefault();var target;switch(evt.which){case 9:case 13:scope.$apply(function(){angular.isNumber(scope.debounceUpdate)||angular.isObject(scope.debounceUpdate)?$$debounce(function(){scope.select(scope.activeIdx,evt)},angular.isNumber(scope.debounceUpdate)?scope.debounceUpdate:scope.debounceUpdate["default"]):scope.select(scope.activeIdx,evt)});break;case 27:evt.stopPropagation(),resetMatches(),scope.$digest();break;case 38:scope.activeIdx=(scope.activeIdx>0?scope.activeIdx:scope.matches.length)-1,scope.$digest(),target=popUpEl.find("li")[scope.activeIdx],target.parentNode.scrollTop=target.offsetTop;break;case 40:scope.activeIdx=(scope.activeIdx+1)%scope.matches.length,scope.$digest(),target=popUpEl.find("li")[scope.activeIdx],target.parentNode.scrollTop=target.offsetTop}}}),element.bind("focus",function(evt){hasFocus=!0,0!==minLength||modelCtrl.$viewValue||$timeout(function(){getMatchesAsync(modelCtrl.$viewValue,evt)},0)}),element.bind("blur",function(evt){isSelectOnBlur&&scope.matches.length&&-1!==scope.activeIdx&&!selected&&(selected=!0,scope.$apply(function(){angular.isObject(scope.debounceUpdate)&&angular.isNumber(scope.debounceUpdate.blur)?$$debounce(function(){scope.select(scope.activeIdx,evt)},scope.debounceUpdate.blur):scope.select(scope.activeIdx,evt)})),!isEditable&&modelCtrl.$error.editable&&(modelCtrl.$viewValue="",element.val("")),hasFocus=!1,selected=!1});var dismissClickHandler=function(evt){element[0]!==evt.target&&3!==evt.which&&0!==scope.matches.length&&(resetMatches(),$rootScope.$$phase||scope.$digest())};$document.on("click",dismissClickHandler),originalScope.$on("$destroy",function(){$document.off("click",dismissClickHandler),(appendToBody||appendTo)&&$popup.remove(),appendToBody&&(angular.element($window).off("resize",fireRecalculating),$document.find("body").off("scroll",fireRecalculating)),popUpEl.remove(),showHint&&inputsContainer.remove()});var $popup=$compile(popUpEl)(scope);appendToBody?$document.find("body").append($popup):appendTo?angular.element(appendTo).eq(0).append($popup):element.after($popup),this.init=function(_modelCtrl,_ngModelOptions){modelCtrl=_modelCtrl,ngModelOptions=_ngModelOptions,scope.debounceUpdate=modelCtrl.$options&&$parse(modelCtrl.$options.debounce)(originalScope),modelCtrl.$parsers.unshift(function(inputValue){return hasFocus=!0,0===minLength||inputValue&&inputValue.length>=minLength?waitTime>0?(cancelPreviousTimeout(),scheduleSearchWithTimeout(inputValue)):getMatchesAsync(inputValue):(isLoadingSetter(originalScope,!1),cancelPreviousTimeout(),resetMatches()),isEditable?inputValue:inputValue?void modelCtrl.$setValidity("editable",!1):(modelCtrl.$setValidity("editable",!0),null)}),modelCtrl.$formatters.push(function(modelValue){var candidateViewValue,emptyViewValue,locals={};return isEditable||modelCtrl.$setValidity("editable",!0),inputFormatter?(locals.$model=modelValue,inputFormatter(originalScope,locals)):(locals[parserResult.itemName]=modelValue,candidateViewValue=parserResult.viewMapper(originalScope,locals),locals[parserResult.itemName]=void 0,emptyViewValue=parserResult.viewMapper(originalScope,locals),candidateViewValue!==emptyViewValue?candidateViewValue:modelValue)})}}]).directive("uibTypeahead",function(){return{controller:"UibTypeaheadController",require:["ngModel","^?ngModelOptions","uibTypeahead"],link:function(originalScope,element,attrs,ctrls){ctrls[2].init(ctrls[0],ctrls[1])}}}).directive("uibTypeaheadPopup",["$$debounce",function($$debounce){return{scope:{matches:"=",query:"=",active:"=",position:"&",moveInProgress:"=",select:"&",assignIsOpen:"&",debounce:"&"},replace:!0,templateUrl:function(element,attrs){return attrs.popupTemplateUrl||"uib/template/typeahead/typeahead-popup.html"},link:function(scope,element,attrs){scope.templateUrl=attrs.templateUrl,scope.isOpen=function(){var isDropdownOpen=scope.matches.length>0;return scope.assignIsOpen({isOpen:isDropdownOpen}),isDropdownOpen},scope.isActive=function(matchIdx){return scope.active===matchIdx},scope.selectActive=function(matchIdx){scope.active=matchIdx},scope.selectMatch=function(activeIdx,evt){var debounce=scope.debounce();angular.isNumber(debounce)||angular.isObject(debounce)?$$debounce(function(){scope.select({activeIdx:activeIdx,evt:evt})},angular.isNumber(debounce)?debounce:debounce["default"]):scope.select({activeIdx:activeIdx,evt:evt})}}}}]).directive("uibTypeaheadMatch",["$templateRequest","$compile","$parse",function($templateRequest,$compile,$parse){return{scope:{index:"=",match:"=",query:"="},link:function(scope,element,attrs){var tplUrl=$parse(attrs.templateUrl)(scope.$parent)||"uib/template/typeahead/typeahead-match.html";$templateRequest(tplUrl).then(function(tplContent){var tplEl=angular.element(tplContent.trim());element.replaceWith(tplEl),$compile(tplEl)(scope)})}}}]).filter("uibTypeaheadHighlight",["$sce","$injector","$log",function($sce,$injector,$log){function escapeRegexp(queryToEscape){return queryToEscape.replace(/([.?*+^$[\]\\(){}|-])/g,"\\$1")}function containsHtml(matchItem){return/<.*>/g.test(matchItem)}var isSanitizePresent;return isSanitizePresent=$injector.has("$sanitize"),function(matchItem,query){return!isSanitizePresent&&containsHtml(matchItem)&&$log.warn("Unsafe use of typeahead please use ngSanitize"),matchItem=query?(""+matchItem).replace(new RegExp(escapeRegexp(query),"gi"),"<strong>$&</strong>"):matchItem,isSanitizePresent||(matchItem=$sce.trustAsHtml(matchItem)),matchItem}}]),angular.module("uib/template/accordion/accordion-group.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/accordion/accordion-group.html",'<div class="panel" ng-class="panelClass || \'panel-default\'">\n  <div role="tab" id="{{::headingId}}" aria-selected="{{isOpen}}" class="panel-heading" ng-keypress="toggleOpen($event)">\n    <h4 class="panel-title">\n      <a role="button" data-toggle="collapse" href aria-expanded="{{isOpen}}" aria-controls="{{::panelId}}" tabindex="0" class="accordion-toggle" ng-click="toggleOpen()" uib-accordion-transclude="heading"><span ng-class="{\'text-muted\': isDisabled}">{{heading}}</span></a>\n    </h4>\n  </div>\n  <div id="{{::panelId}}" aria-labelledby="{{::headingId}}" aria-hidden="{{!isOpen}}" role="tabpanel" class="panel-collapse collapse" uib-collapse="!isOpen">\n    <div class="panel-body" ng-transclude></div>\n  </div>\n</div>\n')}]),angular.module("uib/template/accordion/accordion.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/accordion/accordion.html",'<div role="tablist" class="panel-group" ng-transclude></div>')}]),angular.module("uib/template/alert/alert.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/alert/alert.html",'<div class="alert" ng-class="[\'alert-\' + (type || \'warning\'), closeable ? \'alert-dismissible\' : null]" role="alert">\n    <button ng-show="closeable" type="button" class="close" ng-click="close({$event: $event})">\n        <span aria-hidden="true">&times;</span>\n        <span class="sr-only">Close</span>\n    </button>\n    <div ng-transclude></div>\n</div>\n')}]),angular.module("uib/template/carousel/carousel.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/carousel/carousel.html",'<div ng-mouseenter="pause()" ng-mouseleave="play()" class="carousel" ng-swipe-right="prev()" ng-swipe-left="next()">\n  <div class="carousel-inner" ng-transclude></div>\n  <a role="button" href class="left carousel-control" ng-click="prev()" ng-show="slides.length > 1">\n    <span aria-hidden="true" class="glyphicon glyphicon-chevron-left"></span>\n    <span class="sr-only">previous</span>\n  </a>\n  <a role="button" href class="right carousel-control" ng-click="next()" ng-show="slides.length > 1">\n    <span aria-hidden="true" class="glyphicon glyphicon-chevron-right"></span>\n    <span class="sr-only">next</span>\n  </a>\n  <ol class="carousel-indicators" ng-show="slides.length > 1">\n    <li ng-repeat="slide in slides | orderBy:indexOfSlide track by $index" ng-class="{ active: isActive(slide) }" ng-click="select(slide)">\n      <span class="sr-only">slide {{ $index + 1 }} of {{ slides.length }}<span ng-if="isActive(slide)">, currently active</span></span>\n    </li>\n  </ol>\n</div>')}]),angular.module("uib/template/carousel/slide.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/carousel/slide.html",'<div ng-class="{\n    \'active\': active\n  }" class="item text-center" ng-transclude></div>\n')}]),angular.module("uib/template/datepicker/datepicker.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/datepicker/datepicker.html",'<div class="uib-datepicker" ng-switch="datepickerMode" role="application" ng-keydown="keydown($event)">\n  <uib-daypicker ng-switch-when="day" tabindex="0"></uib-daypicker>\n  <uib-monthpicker ng-switch-when="month" tabindex="0"></uib-monthpicker>\n  <uib-yearpicker ng-switch-when="year" tabindex="0"></uib-yearpicker>\n</div>')}]),angular.module("uib/template/datepicker/day.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/datepicker/day.html",'<table class="uib-daypicker" role="grid" aria-labelledby="{{::uniqueId}}-title" aria-activedescendant="{{activeDateId}}">\n  <thead>\n    <tr>\n      <th><button type="button" class="btn btn-default btn-sm pull-left uib-left" ng-click="move(-1)" tabindex="-1"><i class="glyphicon glyphicon-chevron-left"></i></button></th>\n      <th colspan="{{::5 + showWeeks}}"><button id="{{::uniqueId}}-title" role="heading" aria-live="assertive" aria-atomic="true" type="button" class="btn btn-default btn-sm uib-title" ng-click="toggleMode()" ng-disabled="datepickerMode === maxMode" tabindex="-1"><strong>{{title}}</strong></button></th>\n      <th><button type="button" class="btn btn-default btn-sm pull-right uib-right" ng-click="move(1)" tabindex="-1"><i class="glyphicon glyphicon-chevron-right"></i></button></th>\n    </tr>\n    <tr>\n      <th ng-if="showWeeks" class="text-center"></th>\n      <th ng-repeat="label in ::labels track by $index" class="text-center"><small aria-label="{{::label.full}}">{{::label.abbr}}</small></th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr class="uib-weeks" ng-repeat="row in rows track by $index">\n      <td ng-if="showWeeks" class="text-center h6"><em>{{ weekNumbers[$index] }}</em></td>\n      <td ng-repeat="dt in row" class="uib-day text-center" role="gridcell"\n        id="{{::dt.uid}}"\n        ng-class="::dt.customClass">\n        <button type="button" class="btn btn-default btn-sm"\n          uib-is-class="\n            \'btn-info\' for selectedDt,\n            \'active\' for activeDt\n            on dt"\n          ng-click="select(dt.date)"\n          ng-disabled="::dt.disabled"\n          tabindex="-1"><span ng-class="::{\'text-muted\': dt.secondary, \'text-info\': dt.current}">{{::dt.label}}</span></button>\n      </td>\n    </tr>\n  </tbody>\n</table>\n')}]),angular.module("uib/template/datepicker/month.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/datepicker/month.html",'<table class="uib-monthpicker" role="grid" aria-labelledby="{{::uniqueId}}-title" aria-activedescendant="{{activeDateId}}">\n  <thead>\n    <tr>\n      <th><button type="button" class="btn btn-default btn-sm pull-left uib-left" ng-click="move(-1)" tabindex="-1"><i class="glyphicon glyphicon-chevron-left"></i></button></th>\n      <th><button id="{{::uniqueId}}-title" role="heading" aria-live="assertive" aria-atomic="true" type="button" class="btn btn-default btn-sm uib-title" ng-click="toggleMode()" ng-disabled="datepickerMode === maxMode" tabindex="-1"><strong>{{title}}</strong></button></th>\n      <th><button type="button" class="btn btn-default btn-sm pull-right uib-right" ng-click="move(1)" tabindex="-1"><i class="glyphicon glyphicon-chevron-right"></i></button></th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr class="uib-months" ng-repeat="row in rows track by $index">\n      <td ng-repeat="dt in row" class="uib-month text-center" role="gridcell"\n        id="{{::dt.uid}}"\n        ng-class="::dt.customClass">\n        <button type="button" class="btn btn-default"\n          uib-is-class="\n            \'btn-info\' for selectedDt,\n            \'active\' for activeDt\n            on dt"\n          ng-click="select(dt.date)"\n          ng-disabled="::dt.disabled"\n          tabindex="-1"><span ng-class="::{\'text-info\': dt.current}">{{::dt.label}}</span></button>\n      </td>\n    </tr>\n  </tbody>\n</table>\n')}]),angular.module("uib/template/datepicker/popup.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/datepicker/popup.html",'<div>\n  <ul class="uib-datepicker-popup dropdown-menu" dropdown-nested ng-if="isOpen" ng-style="{top: position.top+\'px\', left: position.left+\'px\'}" ng-keydown="keydown($event)" ng-click="$event.stopPropagation()">\n    <li ng-transclude></li>\n    <li ng-if="showButtonBar" class="uib-button-bar">\n    <span class="btn-group pull-left">\n      <button type="button" class="btn btn-sm btn-info uib-datepicker-current" ng-click="select(\'today\')" ng-disabled="isDisabled(\'today\')">{{ getText(\'current\') }}</button>\n      <button type="button" class="btn btn-sm btn-danger uib-clear" ng-click="select(null)">{{ getText(\'clear\') }}</button>\n    </span>\n      <button type="button" class="btn btn-sm btn-success pull-right uib-close" ng-click="close()">{{ getText(\'close\') }}</button>\n    </li>\n  </ul>\n</div>\n')}]),angular.module("uib/template/datepicker/year.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/datepicker/year.html",'<table class="uib-yearpicker" role="grid" aria-labelledby="{{::uniqueId}}-title" aria-activedescendant="{{activeDateId}}">\n  <thead>\n    <tr>\n      <th><button type="button" class="btn btn-default btn-sm pull-left uib-left" ng-click="move(-1)" tabindex="-1"><i class="glyphicon glyphicon-chevron-left"></i></button></th>\n      <th colspan="{{::columns - 2}}"><button id="{{::uniqueId}}-title" role="heading" aria-live="assertive" aria-atomic="true" type="button" class="btn btn-default btn-sm uib-title" ng-click="toggleMode()" ng-disabled="datepickerMode === maxMode" tabindex="-1"><strong>{{title}}</strong></button></th>\n      <th><button type="button" class="btn btn-default btn-sm pull-right uib-right" ng-click="move(1)" tabindex="-1"><i class="glyphicon glyphicon-chevron-right"></i></button></th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr class="uib-years" ng-repeat="row in rows track by $index">\n      <td ng-repeat="dt in row" class="uib-year text-center" role="gridcell"\n        id="{{::dt.uid}}"\n        ng-class="::dt.customClass">\n        <button type="button" class="btn btn-default"\n          uib-is-class="\n            \'btn-info\' for selectedDt,\n            \'active\' for activeDt\n            on dt"\n          ng-click="select(dt.date)"\n          ng-disabled="::dt.disabled"\n          tabindex="-1"><span ng-class="::{\'text-info\': dt.current}">{{::dt.label}}</span></button>\n      </td>\n    </tr>\n  </tbody>\n</table>\n')}]),angular.module("uib/template/modal/backdrop.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/modal/backdrop.html",'<div class="modal-backdrop"\n     uib-modal-animation-class="fade"\n     modal-in-class="in"\n     ng-style="{\'z-index\': 1040 + (index && 1 || 0) + index*10}"\n></div>\n')}]),angular.module("uib/template/modal/window.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/modal/window.html",'<div modal-render="{{$isRendered}}" tabindex="-1" role="dialog" class="modal"\n    uib-modal-animation-class="fade"\n    modal-in-class="in"\n    ng-style="{\'z-index\': 1050 + index*10, display: \'block\'}">\n    <div class="modal-dialog {{size ? \'modal-\' + size : \'\'}}"><div class="modal-content" uib-modal-transclude></div></div>\n</div>\n')}]),angular.module("uib/template/pager/pager.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/pager/pager.html",'<ul class="pager">\n  <li ng-class="{disabled: noPrevious()||ngDisabled, previous: align}"><a href ng-click="selectPage(page - 1, $event)">{{::getText(\'previous\')}}</a></li>\n  <li ng-class="{disabled: noNext()||ngDisabled, next: align}"><a href ng-click="selectPage(page + 1, $event)">{{::getText(\'next\')}}</a></li>\n</ul>\n')}]),angular.module("uib/template/pagination/pagination.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/pagination/pagination.html",'<ul class="pagination">\n  <li ng-if="::boundaryLinks" ng-class="{disabled: noPrevious()||ngDisabled}" class="pagination-first"><a href ng-click="selectPage(1, $event)">{{::getText(\'first\')}}</a></li>\n  <li ng-if="::directionLinks" ng-class="{disabled: noPrevious()||ngDisabled}" class="pagination-prev"><a href ng-click="selectPage(page - 1, $event)">{{::getText(\'previous\')}}</a></li>\n  <li ng-repeat="page in pages track by $index" ng-class="{active: page.active,disabled: ngDisabled&&!page.active}" class="pagination-page"><a href ng-click="selectPage(page.number, $event)">{{page.text}}</a></li>\n  <li ng-if="::directionLinks" ng-class="{disabled: noNext()||ngDisabled}" class="pagination-next"><a href ng-click="selectPage(page + 1, $event)">{{::getText(\'next\')}}</a></li>\n  <li ng-if="::boundaryLinks" ng-class="{disabled: noNext()||ngDisabled}" class="pagination-last"><a href ng-click="selectPage(totalPages, $event)">{{::getText(\'last\')}}</a></li>\n</ul>\n')}]),angular.module("uib/template/tooltip/tooltip-html-popup.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/tooltip/tooltip-html-popup.html",'<div class="tooltip"\n  tooltip-animation-class="fade"\n  uib-tooltip-classes\n  ng-class="{ in: isOpen() }">\n  <div class="tooltip-arrow"></div>\n  <div class="tooltip-inner" ng-bind-html="contentExp()"></div>\n</div>\n')}]),angular.module("uib/template/tooltip/tooltip-popup.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/tooltip/tooltip-popup.html",'<div class="tooltip"\n  tooltip-animation-class="fade"\n  uib-tooltip-classes\n  ng-class="{ in: isOpen() }">\n  <div class="tooltip-arrow"></div>\n  <div class="tooltip-inner" ng-bind="content"></div>\n</div>\n')}]),angular.module("uib/template/tooltip/tooltip-template-popup.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/tooltip/tooltip-template-popup.html",'<div class="tooltip"\n  tooltip-animation-class="fade"\n  uib-tooltip-classes\n  ng-class="{ in: isOpen() }">\n  <div class="tooltip-arrow"></div>\n  <div class="tooltip-inner"\n    uib-tooltip-template-transclude="contentExp()"\n    tooltip-template-transclude-scope="originScope()"></div>\n</div>\n')}]),angular.module("uib/template/popover/popover-html.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/popover/popover-html.html",'<div class="popover"\n  tooltip-animation-class="fade"\n  uib-tooltip-classes\n  ng-class="{ in: isOpen() }">\n  <div class="arrow"></div>\n\n  <div class="popover-inner">\n      <h3 class="popover-title" ng-bind="title" ng-if="title"></h3>\n      <div class="popover-content" ng-bind-html="contentExp()"></div>\n  </div>\n</div>\n')}]),angular.module("uib/template/popover/popover-template.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/popover/popover-template.html",'<div class="popover"\n  tooltip-animation-class="fade"\n  uib-tooltip-classes\n  ng-class="{ in: isOpen() }">\n  <div class="arrow"></div>\n\n  <div class="popover-inner">\n      <h3 class="popover-title" ng-bind="title" ng-if="title"></h3>\n      <div class="popover-content"\n        uib-tooltip-template-transclude="contentExp()"\n        tooltip-template-transclude-scope="originScope()"></div>\n  </div>\n</div>\n')}]),angular.module("uib/template/popover/popover.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/popover/popover.html",'<div class="popover"\n  tooltip-animation-class="fade"\n  uib-tooltip-classes\n  ng-class="{ in: isOpen() }">\n  <div class="arrow"></div>\n\n  <div class="popover-inner">\n      <h3 class="popover-title" ng-bind="title" ng-if="title"></h3>\n      <div class="popover-content" ng-bind="content"></div>\n  </div>\n</div>\n')}]),angular.module("uib/template/progressbar/bar.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/progressbar/bar.html",'<div class="progress-bar" ng-class="type && \'progress-bar-\' + type" role="progressbar" aria-valuenow="{{value}}" aria-valuemin="0" aria-valuemax="{{max}}" ng-style="{width: (percent < 100 ? percent : 100) + \'%\'}" aria-valuetext="{{percent | number:0}}%" aria-labelledby="{{::title}}" ng-transclude></div>\n')}]),angular.module("uib/template/progressbar/progress.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/progressbar/progress.html",'<div class="progress" ng-transclude aria-labelledby="{{::title}}"></div>')}]),angular.module("uib/template/progressbar/progressbar.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/progressbar/progressbar.html",'<div class="progress">\n  <div class="progress-bar" ng-class="type && \'progress-bar-\' + type" role="progressbar" aria-valuenow="{{value}}" aria-valuemin="0" aria-valuemax="{{max}}" ng-style="{width: (percent < 100 ? percent : 100) + \'%\'}" aria-valuetext="{{percent | number:0}}%" aria-labelledby="{{::title}}" ng-transclude></div>\n</div>\n')}]),angular.module("uib/template/rating/rating.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/rating/rating.html",'<span ng-mouseleave="reset()" ng-keydown="onKeydown($event)" tabindex="0" role="slider" aria-valuemin="0" aria-valuemax="{{range.length}}" aria-valuenow="{{value}}">\n    <span ng-repeat-start="r in range track by $index" class="sr-only">({{ $index < value ? \'*\' : \' \' }})</span>\n    <i ng-repeat-end ng-mouseenter="enter($index + 1)" ng-click="rate($index + 1)" class="glyphicon" ng-class="$index < value && (r.stateOn || \'glyphicon-star\') || (r.stateOff || \'glyphicon-star-empty\')" ng-attr-title="{{r.title}}" aria-valuetext="{{r.title}}"></i>\n</span>\n')}]),angular.module("uib/template/tabs/tab.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/tabs/tab.html",'<li ng-class="{active: active, disabled: disabled}" class="uib-tab">\n  <a href ng-click="select()" uib-tab-heading-transclude>{{heading}}</a>\n</li>\n')}]),angular.module("uib/template/tabs/tabset.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/tabs/tabset.html",'<div>\n  <ul class="nav nav-{{type || \'tabs\'}}" ng-class="{\'nav-stacked\': vertical, \'nav-justified\': justified}" ng-transclude></ul>\n  <div class="tab-content">\n    <div class="tab-pane" \n         ng-repeat="tab in tabs" \n         ng-class="{active: tab.active}"\n         uib-tab-content-transclude="tab">\n    </div>\n  </div>\n</div>\n')}]),angular.module("uib/template/timepicker/timepicker.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/timepicker/timepicker.html",'<table class="uib-timepicker">\n  <tbody>\n    <tr class="text-center" ng-show="::showSpinners">\n      <td class="uib-increment hours"><a ng-click="incrementHours()" ng-class="{disabled: noIncrementHours()}" class="btn btn-link" ng-disabled="noIncrementHours()" tabindex="{{::tabindex}}"><span class="glyphicon glyphicon-chevron-up"></span></a></td>\n      <td>&nbsp;</td>\n      <td class="uib-increment minutes"><a ng-click="incrementMinutes()" ng-class="{disabled: noIncrementMinutes()}" class="btn btn-link" ng-disabled="noIncrementMinutes()" tabindex="{{::tabindex}}"><span class="glyphicon glyphicon-chevron-up"></span></a></td>\n      <td ng-show="showSeconds">&nbsp;</td>\n      <td ng-show="showSeconds" class="uib-increment seconds"><a ng-click="incrementSeconds()" ng-class="{disabled: noIncrementSeconds()}" class="btn btn-link" ng-disabled="noIncrementSeconds()" tabindex="{{::tabindex}}"><span class="glyphicon glyphicon-chevron-up"></span></a></td>\n      <td ng-show="showMeridian"></td>\n    </tr>\n    <tr>\n      <td class="form-group uib-time hours" ng-class="{\'has-error\': invalidHours}">\n        <input style="width:50px;" type="text" placeholder="HH" ng-model="hours" ng-change="updateHours()" class="form-control text-center" ng-readonly="::readonlyInput" maxlength="2" tabindex="{{::tabindex}}" ng-disabled="noIncrementHours()" ng-blur="blur()">\n      </td>\n      <td class="uib-separator">:</td>\n      <td class="form-group uib-time minutes" ng-class="{\'has-error\': invalidMinutes}">\n        <input style="width:50px;" type="text" placeholder="MM" ng-model="minutes" ng-change="updateMinutes()" class="form-control text-center" ng-readonly="::readonlyInput" maxlength="2" tabindex="{{::tabindex}}" ng-disabled="noIncrementMinutes()" ng-blur="blur()">\n      </td>\n      <td ng-show="showSeconds" class="uib-separator">:</td>\n      <td class="form-group uib-time seconds" ng-class="{\'has-error\': invalidSeconds}" ng-show="showSeconds">\n        <input style="width:50px;" type="text" placeholder="SS" ng-model="seconds" ng-change="updateSeconds()" class="form-control text-center" ng-readonly="readonlyInput" maxlength="2" tabindex="{{::tabindex}}" ng-disabled="noIncrementSeconds()" ng-blur="blur()">\n      </td>\n      <td ng-show="showMeridian" class="uib-time am-pm"><button type="button" ng-class="{disabled: noToggleMeridian()}" class="btn btn-default text-center" ng-click="toggleMeridian()" ng-disabled="noToggleMeridian()" tabindex="{{::tabindex}}">{{meridian}}</button></td>\n    </tr>\n    <tr class="text-center" ng-show="::showSpinners">\n      <td class="uib-decrement hours"><a ng-click="decrementHours()" ng-class="{disabled: noDecrementHours()}" class="btn btn-link" ng-disabled="noDecrementHours()" tabindex="{{::tabindex}}"><span class="glyphicon glyphicon-chevron-down"></span></a></td>\n      <td>&nbsp;</td>\n      <td class="uib-decrement minutes"><a ng-click="decrementMinutes()" ng-class="{disabled: noDecrementMinutes()}" class="btn btn-link" ng-disabled="noDecrementMinutes()" tabindex="{{::tabindex}}"><span class="glyphicon glyphicon-chevron-down"></span></a></td>\n      <td ng-show="showSeconds">&nbsp;</td>\n      <td ng-show="showSeconds" class="uib-decrement seconds"><a ng-click="decrementSeconds()" ng-class="{disabled: noDecrementSeconds()}" class="btn btn-link" ng-disabled="noDecrementSeconds()" tabindex="{{::tabindex}}"><span class="glyphicon glyphicon-chevron-down"></span></a></td>\n      <td ng-show="showMeridian"></td>\n    </tr>\n  </tbody>\n</table>\n');
}]),angular.module("uib/template/typeahead/typeahead-match.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/typeahead/typeahead-match.html",'<a href\n   tabindex="-1"\n   ng-bind-html="match.label | uibTypeaheadHighlight:query"\n   ng-attr-title="{{match.label}}"></a>\n')}]),angular.module("uib/template/typeahead/typeahead-popup.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("uib/template/typeahead/typeahead-popup.html",'<ul class="dropdown-menu" ng-show="isOpen() && !moveInProgress" ng-style="{top: position().top+\'px\', left: position().left+\'px\'}" role="listbox" aria-hidden="{{!isOpen()}}">\n    <li ng-repeat="match in matches track by $index" ng-class="{active: isActive($index) }" ng-mouseenter="selectActive($index)" ng-click="selectMatch($index, $event)" role="option" id="{{::match.id}}">\n        <div uib-typeahead-match index="$index" match="match" query="query" template-url="templateUrl"></div>\n    </li>\n</ul>\n')}]),angular.module("ui.bootstrap.carousel").run(function(){!angular.$$csp().noInlineStyle&&angular.element(document).find("head").prepend('<style type="text/css">.ng-animate.item:not(.left):not(.right){-webkit-transition:0s ease-in-out left;transition:0s ease-in-out left}</style>')}),angular.module("ui.bootstrap.datepicker").run(function(){!angular.$$csp().noInlineStyle&&angular.element(document).find("head").prepend('<style type="text/css">.uib-datepicker .uib-title{width:100%;}.uib-day button,.uib-month button,.uib-year button{min-width:100%;}.uib-datepicker-popup.dropdown-menu{display:block;}.uib-button-bar{padding:10px 9px 2px;}</style>')}),angular.module("ui.bootstrap.timepicker").run(function(){!angular.$$csp().noInlineStyle&&angular.element(document).find("head").prepend('<style type="text/css">.uib-time input{width:50px;}</style>')}),angular.module("ui.bootstrap.typeahead").run(function(){!angular.$$csp().noInlineStyle&&angular.element(document).find("head").prepend('<style type="text/css">[uib-typeahead-popup].dropdown-menu{display:block;}</style>')}),!function(){"use strict";angular.module("ngtweet",[]).value("logVerbose",!0)}(),function(){"use strict";function e(e,t){var n=function(){},i=function(e){return t===!0?e:n};return{log:i(e.log),debug:i(e.debug),info:i(e.info),warn:e.warn,error:e.error}}e.$inject=["e","t"],e.$inject=["$log","logVerbose"],angular.module("ngtweet").factory("ngTweetLogger",e)}(),function(){"use strict";function e(e,t){return{restrict:"E",replace:!0,transclude:!0,scope:{twitterTimelineId:"=",twitterTimelineScreenName:"=?"},template:'<div class="ngtweet-wrapper" ng-transclude></div>',link:function(n,i,r){e.debug("Linking",i,r),angular.isString(n.twitterTimelineId)||e.warn("twitterTimelineId should probably be a string due to loss of precision.");try{n.twitterTimelineOptions=JSON.parse(r.twitterTimelineOptions)}catch(o){n.$watch(function(){return n.$parent.$eval(r.twitterTimelineOptions)},function(e,t){n.twitterTimelineOptions=e})}angular.isUndefined(n.twitterTimelineOptions)&&(n.twitterTimelineOptions={}),!angular.isUndefined(n.twitterTimelineId)||angular.isString(n.twitterTimelineScreenName)?t.createTimeline(n.twitterTimelineId,n.twitterTimelineScreenName,i[0],n.twitterTimelineOptions).then(function(t){e.debug("Timeline Success!!!")})["catch"](function(t){e.error("Could not create timeline: ",t,i)}):t.load(i[0])}}}e.$inject=["e","t"],e.$inject=["ngTweetLogger","TwitterWidgetFactory"],angular.module("ngtweet").directive("twitterTimeline",e)}(),function(){"use strict";function e(e,t){return{restrict:"E",replace:!0,transclude:!0,scope:{twitterWidgetId:"=",twitterWidgetOptions:"="},template:'<div class="ngtweet-wrapper" ng-transclude></div>',link:function(n,i,r){e.debug("Linking",i,r),angular.isUndefined(n.twitterWidgetId)?t.load(i[0]):(angular.isString(n.twitterWidgetId)||e.warn("twitterWidgetId should probably be a string due to loss of precision."),t.createTweet(n.twitterWidgetId,i[0],n.twitterWidgetOptions).then(function(t){e.debug("Success!!!")})["catch"](function(t){e.error("Could not create widget: ",t,i)}))}}}e.$inject=["e","t"],e.$inject=["ngTweetLogger","TwitterWidgetFactory"],angular.module("ngtweet").directive("twitterWidget",e)}(),function(){"use strict";function e(e,t,n,i,r){function o(){r.twttr=function(e,t,n){var i,o=e.getElementsByTagName(t)[0],c=r.twttr||{};return e.getElementById(n)?void 0:(i=e.createElement(t),i.id=n,i.src="//platform.twitter.com/widgets.js",o.parentNode.insertBefore(i,o),c._e=[],c.ready=function(e){c._e.push(e)},c)}(e[0],"script","twitter-wjs")}function c(){return angular.isUndefined(l)?(l=i.defer(),o(),r.twttr.ready(function(e){n.debug("Twitter script ready"),e.events.bind("rendered",u),l.resolve(e)}),l.promise):l.promise}function u(e){n.debug("Tweet rendered",e.target.parentElement.attributes)}function a(e,t,r){return c().then(function(o){return n.debug("Creating Tweet",o,e,t,r),i.when(o.widgets.createTweet(e,t,r))})}function g(e,t,r,o){return c().then(function(c){return n.debug("Creating Timeline",e,t,o,r),angular.isString(t)&&t.length>0&&(o.screenName=t),i.when(c.widgets.createTimeline(e,r,o))})}function d(e){c().then(function(t){n.debug("Wrapping",t,e),t.widgets.load(e)})["catch"](function(t){n.error("Could not wrap element: ",t,e)})}var l;return{createTweet:a,createTimeline:g,initialize:o,load:d}}e.$inject=["e","t","n","i","r"],e.$inject=["$document","$http","ngTweetLogger","$q","$window"],angular.module("ngtweet").factory("TwitterWidgetFactory",e)}(),function(){"use strict";function e(e,t){return{restrict:"A",replace:!1,scope:!1,link:function(n,i,r){e.debug("Initializing"),t.initialize()}}}e.$inject=["e","t"],e.$inject=["ngTweetLogger","TwitterWidgetFactory"],angular.module("ngtweet").directive("twitterWidgetInitialize",e)}(),function(){"use strict";function e(e){e.decorator("logVerbose",["$delegate",function(e){return!1}])}e.$inject=["e"],e.$inject=["$provide"],angular.module("ngtweet").config(e)}(),function(window,angular){"use strict";function $SanitizeProvider(){var svgEnabled=!1;this.$get=["$$sanitizeUri",function($$sanitizeUri){return svgEnabled&&angular.extend(validElements,svgElements),function(html){var buf=[];return htmlParser(html,htmlSanitizeWriter(buf,function(uri,isImage){return!/^unsafe:/.test($$sanitizeUri(uri,isImage))})),buf.join("")}}],this.enableSvg=function(enableSvg){return angular.isDefined(enableSvg)?(svgEnabled=enableSvg,this):svgEnabled}}function sanitizeText(chars){var buf=[],writer=htmlSanitizeWriter(buf,angular.noop);return writer.chars(chars),buf.join("")}function toMap(str,lowercaseKeys){var i,obj={},items=str.split(",");for(i=0;i<items.length;i++)obj[lowercaseKeys?angular.lowercase(items[i]):items[i]]=!0;return obj}function htmlParser(html,handler){null===html||void 0===html?html="":"string"!=typeof html&&(html=""+html),inertBodyElement.innerHTML=html;var mXSSAttempts=5;do{if(0===mXSSAttempts)throw $sanitizeMinErr("uinput","Failed to sanitize html because the input is unstable");mXSSAttempts--,window.document.documentMode&&stripCustomNsAttrs(inertBodyElement),html=inertBodyElement.innerHTML,inertBodyElement.innerHTML=html}while(html!==inertBodyElement.innerHTML);for(var node=inertBodyElement.firstChild;node;){switch(node.nodeType){case 1:handler.start(node.nodeName.toLowerCase(),attrToMap(node.attributes));break;case 3:handler.chars(node.textContent)}var nextNode;if(!(nextNode=node.firstChild)&&(1==node.nodeType&&handler.end(node.nodeName.toLowerCase()),nextNode=node.nextSibling,!nextNode))for(;null==nextNode&&(node=node.parentNode,node!==inertBodyElement);)nextNode=node.nextSibling,1==node.nodeType&&handler.end(node.nodeName.toLowerCase());node=nextNode}for(;node=inertBodyElement.firstChild;)inertBodyElement.removeChild(node)}function attrToMap(attrs){for(var map={},i=0,ii=attrs.length;ii>i;i++){var attr=attrs[i];map[attr.name]=attr.value}return map}function encodeEntities(value){return value.replace(/&/g,"&amp;").replace(SURROGATE_PAIR_REGEXP,function(value){var hi=value.charCodeAt(0),low=value.charCodeAt(1);return"&#"+(1024*(hi-55296)+(low-56320)+65536)+";"}).replace(NON_ALPHANUMERIC_REGEXP,function(value){return"&#"+value.charCodeAt(0)+";"}).replace(/</g,"&lt;").replace(/>/g,"&gt;")}function htmlSanitizeWriter(buf,uriValidator){var ignoreCurrentElement=!1,out=angular.bind(buf,buf.push);return{start:function(tag,attrs){tag=angular.lowercase(tag),!ignoreCurrentElement&&blockedElements[tag]&&(ignoreCurrentElement=tag),ignoreCurrentElement||validElements[tag]!==!0||(out("<"),out(tag),angular.forEach(attrs,function(value,key){var lkey=angular.lowercase(key),isImage="img"===tag&&"src"===lkey||"background"===lkey;validAttrs[lkey]!==!0||uriAttrs[lkey]===!0&&!uriValidator(value,isImage)||(out(" "),out(key),out('="'),out(encodeEntities(value)),out('"'))}),out(">"))},end:function(tag){tag=angular.lowercase(tag),ignoreCurrentElement||validElements[tag]!==!0||voidElements[tag]===!0||(out("</"),out(tag),out(">")),tag==ignoreCurrentElement&&(ignoreCurrentElement=!1)},chars:function(chars){ignoreCurrentElement||out(encodeEntities(chars))}}}function stripCustomNsAttrs(node){if(node.nodeType===window.Node.ELEMENT_NODE)for(var attrs=node.attributes,i=0,l=attrs.length;l>i;i++){var attrNode=attrs[i],attrName=attrNode.name.toLowerCase();("xmlns:ns1"===attrName||0===attrName.lastIndexOf("ns1:",0))&&(node.removeAttributeNode(attrNode),i--,l--)}var nextNode=node.firstChild;nextNode&&stripCustomNsAttrs(nextNode),nextNode=node.nextSibling,nextNode&&stripCustomNsAttrs(nextNode)}var inertBodyElement,$sanitizeMinErr=angular.$$minErr("$sanitize"),SURROGATE_PAIR_REGEXP=/[\uD800-\uDBFF][\uDC00-\uDFFF]/g,NON_ALPHANUMERIC_REGEXP=/([^\#-~ |!])/g,voidElements=toMap("area,br,col,hr,img,wbr"),optionalEndTagBlockElements=toMap("colgroup,dd,dt,li,p,tbody,td,tfoot,th,thead,tr"),optionalEndTagInlineElements=toMap("rp,rt"),optionalEndTagElements=angular.extend({},optionalEndTagInlineElements,optionalEndTagBlockElements),blockElements=angular.extend({},optionalEndTagBlockElements,toMap("address,article,aside,blockquote,caption,center,del,dir,div,dl,figure,figcaption,footer,h1,h2,h3,h4,h5,h6,header,hgroup,hr,ins,map,menu,nav,ol,pre,section,table,ul")),inlineElements=angular.extend({},optionalEndTagInlineElements,toMap("a,abbr,acronym,b,bdi,bdo,big,br,cite,code,del,dfn,em,font,i,img,ins,kbd,label,map,mark,q,ruby,rp,rt,s,samp,small,span,strike,strong,sub,sup,time,tt,u,var")),svgElements=toMap("circle,defs,desc,ellipse,font-face,font-face-name,font-face-src,g,glyph,hkern,image,linearGradient,line,marker,metadata,missing-glyph,mpath,path,polygon,polyline,radialGradient,rect,stop,svg,switch,text,title,tspan"),blockedElements=toMap("script,style"),validElements=angular.extend({},voidElements,blockElements,inlineElements,optionalEndTagElements),uriAttrs=toMap("background,cite,href,longdesc,src,xlink:href"),htmlAttrs=toMap("abbr,align,alt,axis,bgcolor,border,cellpadding,cellspacing,class,clear,color,cols,colspan,compact,coords,dir,face,headers,height,hreflang,hspace,ismap,lang,language,nohref,nowrap,rel,rev,rows,rowspan,rules,scope,scrolling,shape,size,span,start,summary,tabindex,target,title,type,valign,value,vspace,width"),svgAttrs=toMap("accent-height,accumulate,additive,alphabetic,arabic-form,ascent,baseProfile,bbox,begin,by,calcMode,cap-height,class,color,color-rendering,content,cx,cy,d,dx,dy,descent,display,dur,end,fill,fill-rule,font-family,font-size,font-stretch,font-style,font-variant,font-weight,from,fx,fy,g1,g2,glyph-name,gradientUnits,hanging,height,horiz-adv-x,horiz-origin-x,ideographic,k,keyPoints,keySplines,keyTimes,lang,marker-end,marker-mid,marker-start,markerHeight,markerUnits,markerWidth,mathematical,max,min,offset,opacity,orient,origin,overline-position,overline-thickness,panose-1,path,pathLength,points,preserveAspectRatio,r,refX,refY,repeatCount,repeatDur,requiredExtensions,requiredFeatures,restart,rotate,rx,ry,slope,stemh,stemv,stop-color,stop-opacity,strikethrough-position,strikethrough-thickness,stroke,stroke-dasharray,stroke-dashoffset,stroke-linecap,stroke-linejoin,stroke-miterlimit,stroke-opacity,stroke-width,systemLanguage,target,text-anchor,to,transform,type,u1,u2,underline-position,underline-thickness,unicode,unicode-range,units-per-em,values,version,viewBox,visibility,width,widths,x,x-height,x1,x2,xlink:actuate,xlink:arcrole,xlink:role,xlink:show,xlink:title,xlink:type,xml:base,xml:lang,xml:space,xmlns,xmlns:xlink,y,y1,y2,zoomAndPan",!0),validAttrs=angular.extend({},uriAttrs,svgAttrs,htmlAttrs);!function(window){var doc;if(!window.document||!window.document.implementation)throw $sanitizeMinErr("noinert","Can't create an inert html document");doc=window.document.implementation.createHTMLDocument("inert");var docElement=doc.documentElement||doc.getDocumentElement(),bodyElements=docElement.getElementsByTagName("body");if(1===bodyElements.length)inertBodyElement=bodyElements[0];else{var html=doc.createElement("html");inertBodyElement=doc.createElement("body"),html.appendChild(inertBodyElement),doc.appendChild(html)}}(window),angular.module("ngSanitize",[]).provider("$sanitize",$SanitizeProvider),angular.module("ngSanitize").filter("linky",["$sanitize",function($sanitize){var LINKY_URL_REGEXP=/((ftp|https?):\/\/|(www\.)|(mailto:)?[A-Za-z0-9._%+-]+@)\S*[^\s.;,(){}<>"\u201d\u2019]/i,MAILTO_REGEXP=/^mailto:/i,linkyMinErr=angular.$$minErr("linky"),isString=angular.isString;return function(text,target,attributes){function addText(text){text&&html.push(sanitizeText(text))}function addLink(url,text){var key,linkAttributes=attributesFn(url);html.push("<a ");for(key in linkAttributes)html.push(key+'="'+linkAttributes[key]+'" ');!angular.isDefined(target)||"target"in linkAttributes||html.push('target="',target,'" '),html.push('href="',url.replace(/"/g,"&quot;"),'">'),addText(text),html.push("</a>")}if(null==text||""===text)return text;if(!isString(text))throw linkyMinErr("notstring","Expected string but received: {0}",text);for(var match,url,i,attributesFn=angular.isFunction(attributes)?attributes:angular.isObject(attributes)?function(){return attributes}:function(){return{}},raw=text,html=[];match=raw.match(LINKY_URL_REGEXP);)url=match[0],match[2]||match[4]||(url=(match[3]?"http://":"mailto:")+url),i=match.index,addText(raw.substr(0,i)),addLink(url,match[0].replace(MAILTO_REGEXP,"")),raw=raw.substring(i+match[0].length);return addText(raw),$sanitize(html.join(""))}}])}(window,window.angular),function(){"use strict";angular.module("cfp.hotkeys",[]).provider("hotkeys",["$injector",function($injector){this.includeCheatSheet=!0,this.useNgRoute=$injector.has("ngViewDirective"),this.templateTitle="Keyboard Shortcuts:",this.templateHeader=null,this.templateFooter=null,this.template='<div class="cfp-hotkeys-container fade" ng-class="{in: helpVisible}" style="display: none;"><div class="cfp-hotkeys"><h4 class="cfp-hotkeys-title" ng-if="!header">{{ title }}</h4><div ng-bind-html="header" ng-if="header"></div><table><tbody><tr ng-repeat="hotkey in hotkeys | filter:{ description: \'!$$undefined$$\' }"><td class="cfp-hotkeys-keys"><span ng-repeat="key in hotkey.format() track by $index" class="cfp-hotkeys-key">{{ key }}</span></td><td class="cfp-hotkeys-text">{{ hotkey.description }}</td></tr></tbody></table><div ng-bind-html="footer" ng-if="footer"></div><div class="cfp-hotkeys-close" ng-click="toggleCheatSheet()">&#215;</div></div></div>',this.cheatSheetHotkey="?",this.cheatSheetDescription="Show / hide this help menu",this.$get=["$rootElement","$rootScope","$compile","$window","$document",function($rootElement,$rootScope,$compile,$window,$document){function pause(){mouseTrapEnabled=!1}function unpause(){mouseTrapEnabled=!0}function symbolize(combo){var map={command:"⌘",shift:"⇧",left:"←",right:"→",up:"↑",down:"↓","return":"⏎",backspace:"⌫"};combo=combo.split("+");for(var i=0;i<combo.length;i++)"mod"===combo[i]&&($window.navigator&&$window.navigator.platform.indexOf("Mac")>=0?combo[i]="command":combo[i]="ctrl"),combo[i]=map[combo[i]]||combo[i];return combo.join(" + ")}function Hotkey(combo,description,callback,action,allowIn,persistent){this.combo=combo instanceof Array?combo:[combo],this.description=description,this.callback=callback,this.action=action,this.allowIn=allowIn,this.persistent=persistent,this._formated=null}function purgeHotkeys(){for(var i=scope.hotkeys.length;i--;){var hotkey=scope.hotkeys[i];hotkey&&!hotkey.persistent&&_del(hotkey)}}function toggleCheatSheet(){scope.helpVisible=!scope.helpVisible,scope.helpVisible?(previousEsc=_get("esc"),_del("esc"),_add("esc",previousEsc.description,toggleCheatSheet,null,["INPUT","SELECT","TEXTAREA"])):(_del("esc"),previousEsc!==!1&&_add(previousEsc))}function _add(combo,description,callback,action,allowIn,persistent){var _callback,preventIn=["INPUT","SELECT","TEXTAREA"],objType=Object.prototype.toString.call(combo);if("[object Object]"===objType&&(description=combo.description,callback=combo.callback,action=combo.action,persistent=combo.persistent,allowIn=combo.allowIn,combo=combo.combo),_del(combo),description instanceof Function?(action=callback,callback=description,description="$$undefined$$"):angular.isUndefined(description)&&(description="$$undefined$$"),void 0===persistent&&(persistent=!0),"function"==typeof callback){_callback=callback,allowIn instanceof Array||(allowIn=[]);for(var index,i=0;i<allowIn.length;i++)allowIn[i]=allowIn[i].toUpperCase(),index=preventIn.indexOf(allowIn[i]),-1!==index&&preventIn.splice(index,1);callback=function(event){var shouldExecute=!0;if(event){var target=event.target||event.srcElement,nodeName=target.nodeName.toUpperCase();if((" "+target.className+" ").indexOf(" mousetrap ")>-1)shouldExecute=!0;else for(var i=0;i<preventIn.length;i++)if(preventIn[i]===nodeName){shouldExecute=!1;break}}shouldExecute&&wrapApply(_callback.apply(this,arguments))}}"string"==typeof action?Mousetrap.bind(combo,wrapApply(callback),action):Mousetrap.bind(combo,wrapApply(callback));var hotkey=new Hotkey(combo,description,callback,action,allowIn,persistent);return scope.hotkeys.push(hotkey),hotkey}function _del(hotkey){var combo=hotkey instanceof Hotkey?hotkey.combo:hotkey;if(Mousetrap.unbind(combo),angular.isArray(combo)){for(var retStatus=!0,i=combo.length;i--;)retStatus=_del(combo[i])&&retStatus;return retStatus}var index=scope.hotkeys.indexOf(_get(combo));return index>-1?(scope.hotkeys[index].combo.length>1?scope.hotkeys[index].combo.splice(scope.hotkeys[index].combo.indexOf(combo),1):(angular.forEach(boundScopes,function(boundScope){var scopeIndex=boundScope.indexOf(scope.hotkeys[index]);-1!==scopeIndex&&boundScope.splice(scopeIndex,1)}),scope.hotkeys.splice(index,1)),!0):!1}function _get(combo){if(!combo)return scope.hotkeys;for(var hotkey,i=0;i<scope.hotkeys.length;i++)if(hotkey=scope.hotkeys[i],hotkey.combo.indexOf(combo)>-1)return hotkey;return!1}function bindTo(scope){return scope.$id in boundScopes||(boundScopes[scope.$id]=[],scope.$on("$destroy",function(){for(var i=boundScopes[scope.$id].length;i--;)_del(boundScopes[scope.$id].pop())})),{add:function(args){var hotkey;return hotkey=arguments.length>1?_add.apply(this,arguments):_add(args),boundScopes[scope.$id].push(hotkey),this}}}function wrapApply(callback){return function(event,combo){if(callback instanceof Array){var funcString=callback[0],route=callback[1];callback=function(event){route.scope.$eval(funcString)}}$rootScope.$apply(function(){callback(event,_get(combo))})}}var mouseTrapEnabled=!0;Mousetrap.prototype.stopCallback=function(event,element){return mouseTrapEnabled?(" "+element.className+" ").indexOf(" mousetrap ")>-1?!1:element.contentEditable&&"true"==element.contentEditable:!0},Hotkey.prototype.format=function(){if(null===this._formated){for(var combo=this.combo[0],sequence=combo.split(/[\s]/),i=0;i<sequence.length;i++)sequence[i]=symbolize(sequence[i]);this._formated=sequence}return this._formated};var scope=$rootScope.$new();scope.hotkeys=[],scope.helpVisible=!1,scope.title=this.templateTitle,scope.header=this.templateHeader,scope.footer=this.templateFooter,scope.toggleCheatSheet=toggleCheatSheet;var boundScopes={};if(this.useNgRoute&&$rootScope.$on("$routeChangeSuccess",function(event,route){purgeHotkeys(),route&&route.hotkeys&&angular.forEach(route.hotkeys,function(hotkey){var callback=hotkey[2];("string"==typeof callback||callback instanceof String)&&(hotkey[2]=[callback,route]),hotkey[5]=!1,_add.apply(this,hotkey)})}),this.includeCheatSheet){var document=$document[0],element=$rootElement[0],helpMenu=angular.element(this.template);_add(this.cheatSheetHotkey,this.cheatSheetDescription,toggleCheatSheet),(element===document||element===document.documentElement)&&(element=document.body),angular.element(element).append($compile(helpMenu)(scope))}var previousEsc=!1,publicApi={add:_add,del:_del,get:_get,bindTo:bindTo,template:this.template,toggleCheatSheet:toggleCheatSheet,includeCheatSheet:this.includeCheatSheet,cheatSheetHotkey:this.cheatSheetHotkey,cheatSheetDescription:this.cheatSheetDescription,useNgRoute:this.useNgRoute,purgeHotkeys:purgeHotkeys,templateTitle:this.templateTitle,pause:pause,unpause:unpause};return publicApi}]}]).directive("hotkey",["hotkeys",function(hotkeys){return{restrict:"A",link:function(scope,el,attrs){var allowIn,keys=[];angular.forEach(scope.$eval(attrs.hotkey),function(func,hotkey){allowIn="string"==typeof attrs.hotkeyAllowIn?attrs.hotkeyAllowIn.split(/[\s,]+/):[],keys.push(hotkey),hotkeys.add({combo:hotkey,description:attrs.hotkeyDescription,callback:func,action:attrs.hotkeyAction,allowIn:allowIn})}),el.bind("$destroy",function(){angular.forEach(keys,hotkeys.del)})}}}]).run(["hotkeys",function(hotkeys){}])}(),function(window,document,undefined){function _addEvent(object,type,callback){return object.addEventListener?void object.addEventListener(type,callback,!1):void object.attachEvent("on"+type,callback)}function _characterFromEvent(e){if("keypress"==e.type){var character=String.fromCharCode(e.which);return e.shiftKey||(character=character.toLowerCase()),character}return _MAP[e.which]?_MAP[e.which]:_KEYCODE_MAP[e.which]?_KEYCODE_MAP[e.which]:String.fromCharCode(e.which).toLowerCase()}function _modifiersMatch(modifiers1,modifiers2){return modifiers1.sort().join(",")===modifiers2.sort().join(",")}function _eventModifiers(e){var modifiers=[];return e.shiftKey&&modifiers.push("shift"),e.altKey&&modifiers.push("alt"),e.ctrlKey&&modifiers.push("ctrl"),e.metaKey&&modifiers.push("meta"),modifiers}function _preventDefault(e){return e.preventDefault?void e.preventDefault():void(e.returnValue=!1)}function _stopPropagation(e){return e.stopPropagation?void e.stopPropagation():void(e.cancelBubble=!0)}function _isModifier(key){return"shift"==key||"ctrl"==key||"alt"==key||"meta"==key}function _getReverseMap(){if(!_REVERSE_MAP){_REVERSE_MAP={};for(var key in _MAP)key>95&&112>key||_MAP.hasOwnProperty(key)&&(_REVERSE_MAP[_MAP[key]]=key)}return _REVERSE_MAP}function _pickBestAction(key,modifiers,action){return action||(action=_getReverseMap()[key]?"keydown":"keypress"),"keypress"==action&&modifiers.length&&(action="keydown"),action}function _keysFromString(combination){return"+"===combination?["+"]:(combination=combination.replace(/\+{2}/g,"+plus"),combination.split("+"))}function _getKeyInfo(combination,action){var keys,key,i,modifiers=[];for(keys=_keysFromString(combination),i=0;i<keys.length;++i)key=keys[i],_SPECIAL_ALIASES[key]&&(key=_SPECIAL_ALIASES[key]),action&&"keypress"!=action&&_SHIFT_MAP[key]&&(key=_SHIFT_MAP[key],modifiers.push("shift")),_isModifier(key)&&modifiers.push(key);return action=_pickBestAction(key,modifiers,action),{key:key,modifiers:modifiers,action:action}}function _belongsTo(element,ancestor){return element===document?!1:element===ancestor?!0:_belongsTo(element.parentNode,ancestor)}function Mousetrap(targetElement){function _resetSequences(doNotReset){doNotReset=doNotReset||{};var key,activeSequences=!1;for(key in _sequenceLevels)doNotReset[key]?activeSequences=!0:_sequenceLevels[key]=0;activeSequences||(_nextExpectedAction=!1)}function _getMatches(character,modifiers,e,sequenceName,combination,level){var i,callback,matches=[],action=e.type;if(!self._callbacks[character])return[];for("keyup"==action&&_isModifier(character)&&(modifiers=[character]),i=0;i<self._callbacks[character].length;++i)if(callback=self._callbacks[character][i],(sequenceName||!callback.seq||_sequenceLevels[callback.seq]==callback.level)&&action==callback.action&&("keypress"==action&&!e.metaKey&&!e.ctrlKey||_modifiersMatch(modifiers,callback.modifiers))){var deleteCombo=!sequenceName&&callback.combo==combination,deleteSequence=sequenceName&&callback.seq==sequenceName&&callback.level==level;(deleteCombo||deleteSequence)&&self._callbacks[character].splice(i,1),matches.push(callback)}return matches}function _fireCallback(callback,e,combo,sequence){self.stopCallback(e,e.target||e.srcElement,combo,sequence)||callback(e,combo)===!1&&(_preventDefault(e),_stopPropagation(e))}function _handleKeyEvent(e){"number"!=typeof e.which&&(e.which=e.keyCode);var character=_characterFromEvent(e);if(character)return"keyup"==e.type&&_ignoreNextKeyup===character?void(_ignoreNextKeyup=!1):void self.handleKey(character,_eventModifiers(e),e)}function _resetSequenceTimer(){clearTimeout(_resetTimer),_resetTimer=setTimeout(_resetSequences,1e3)}function _bindSequence(combo,keys,callback,action){function _increaseSequence(nextAction){return function(){_nextExpectedAction=nextAction,++_sequenceLevels[combo],_resetSequenceTimer()}}function _callbackAndReset(e){_fireCallback(callback,e,combo),"keyup"!==action&&(_ignoreNextKeyup=_characterFromEvent(e)),setTimeout(_resetSequences,10)}_sequenceLevels[combo]=0;for(var i=0;i<keys.length;++i){var isFinal=i+1===keys.length,wrappedCallback=isFinal?_callbackAndReset:_increaseSequence(action||_getKeyInfo(keys[i+1]).action);_bindSingle(keys[i],wrappedCallback,action,combo,i)}}function _bindSingle(combination,callback,action,sequenceName,level){self._directMap[combination+":"+action]=callback,combination=combination.replace(/\s+/g," ");var info,sequence=combination.split(" ");return sequence.length>1?void _bindSequence(combination,sequence,callback,action):(info=_getKeyInfo(combination,action),self._callbacks[info.key]=self._callbacks[info.key]||[],_getMatches(info.key,info.modifiers,{type:info.action},sequenceName,combination,level),void self._callbacks[info.key][sequenceName?"unshift":"push"]({callback:callback,modifiers:info.modifiers,action:info.action,seq:sequenceName,level:level,combo:combination}))}var self=this;if(targetElement=targetElement||document,!(self instanceof Mousetrap))return new Mousetrap(targetElement);self.target=targetElement,self._callbacks={},self._directMap={};var _resetTimer,_sequenceLevels={},_ignoreNextKeyup=!1,_ignoreNextKeypress=!1,_nextExpectedAction=!1;self._handleKey=function(character,modifiers,e){var i,callbacks=_getMatches(character,modifiers,e),doNotReset={},maxLevel=0,processedSequenceCallback=!1;for(i=0;i<callbacks.length;++i)callbacks[i].seq&&(maxLevel=Math.max(maxLevel,callbacks[i].level));for(i=0;i<callbacks.length;++i)if(callbacks[i].seq){if(callbacks[i].level!=maxLevel)continue;processedSequenceCallback=!0,doNotReset[callbacks[i].seq]=1,_fireCallback(callbacks[i].callback,e,callbacks[i].combo,callbacks[i].seq)}else processedSequenceCallback||_fireCallback(callbacks[i].callback,e,callbacks[i].combo);var ignoreThisKeypress="keypress"==e.type&&_ignoreNextKeypress;e.type!=_nextExpectedAction||_isModifier(character)||ignoreThisKeypress||_resetSequences(doNotReset),_ignoreNextKeypress=processedSequenceCallback&&"keydown"==e.type},self._bindMultiple=function(combinations,callback,action){for(var i=0;i<combinations.length;++i)_bindSingle(combinations[i],callback,action)},_addEvent(targetElement,"keypress",_handleKeyEvent),_addEvent(targetElement,"keydown",_handleKeyEvent),_addEvent(targetElement,"keyup",_handleKeyEvent)}for(var _REVERSE_MAP,_MAP={8:"backspace",9:"tab",13:"enter",16:"shift",17:"ctrl",18:"alt",20:"capslock",27:"esc",32:"space",33:"pageup",34:"pagedown",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"ins",46:"del",91:"meta",93:"meta",224:"meta"},_KEYCODE_MAP={106:"*",107:"+",109:"-",110:".",111:"/",186:";",187:"=",188:",",189:"-",190:".",191:"/",192:"`",219:"[",220:"\\",221:"]",222:"'"},_SHIFT_MAP={"~":"`","!":"1","@":"2","#":"3",$:"4","%":"5","^":"6","&":"7","*":"8","(":"9",")":"0",_:"-","+":"=",":":";",'"':"'","<":",",">":".","?":"/","|":"\\"},_SPECIAL_ALIASES={option:"alt",command:"meta","return":"enter",escape:"esc",plus:"+",mod:/Mac|iPod|iPhone|iPad/.test(navigator.platform)?"meta":"ctrl"},i=1;20>i;++i)_MAP[111+i]="f"+i;for(i=0;9>=i;++i)_MAP[i+96]=i;Mousetrap.prototype.bind=function(keys,callback,action){var self=this;return keys=keys instanceof Array?keys:[keys],self._bindMultiple.call(self,keys,callback,action),self},Mousetrap.prototype.unbind=function(keys,action){var self=this;return self.bind.call(self,keys,function(){},action)},Mousetrap.prototype.trigger=function(keys,action){var self=this;return self._directMap[keys+":"+action]&&self._directMap[keys+":"+action]({},keys),self},Mousetrap.prototype.reset=function(){var self=this;return self._callbacks={},self._directMap={},self},Mousetrap.prototype.stopCallback=function(e,element){var self=this;return(" "+element.className+" ").indexOf(" mousetrap ")>-1?!1:_belongsTo(element,self.target)?!1:"INPUT"==element.tagName||"SELECT"==element.tagName||"TEXTAREA"==element.tagName||element.isContentEditable},Mousetrap.prototype.handleKey=function(){var self=this;return self._handleKey.apply(self,arguments)},Mousetrap.init=function(){var documentMousetrap=Mousetrap(document);for(var method in documentMousetrap)"_"!==method.charAt(0)&&(Mousetrap[method]=function(method){return function(){return documentMousetrap[method].apply(documentMousetrap,arguments)}}(method))},Mousetrap.init(),window.Mousetrap=Mousetrap,"undefined"!=typeof module&&module.exports&&(module.exports=Mousetrap),"function"==typeof define&&define.amd&&define(function(){return Mousetrap})}(window,document),function(window,angular,undefined){"use strict";function makeSwipeDirective(directiveName,direction,axis,eventName){ngSwipe.directive(directiveName,["$parse","swipe",function($parse,swipe){var MAX_OTHER_AXIS_DISTANCE=75,MAX_RATIO=.3,MIN_DISTANCE=30;return function(scope,element,attr){function validSwipe(coords){if(!startCoords||!valid)return!1;var deltaY=(coords.y-startCoords.y)*direction,deltaX=(coords.x-startCoords.x)*direction;return axis?Math.abs(deltaX)<MAX_OTHER_AXIS_DISTANCE&&deltaY>0&&deltaY>MIN_DISTANCE&&Math.abs(deltaX)/deltaY<MAX_RATIO:Math.abs(deltaY)<MAX_OTHER_AXIS_DISTANCE&&deltaX>0&&deltaX>MIN_DISTANCE&&Math.abs(deltaY)/deltaX<MAX_RATIO}var startCoords,valid,swipeHandler=$parse(attr[directiveName]),pointerTypes=["touch"];angular.isDefined(attr.ngSwipeDisableMouse)||pointerTypes.push("mouse"),swipe.bind(element,{start:function(coords,event){var className=event.target.getAttribute("class");axis&&(!className||className&&null===className.match("noPreventDefault"))&&event.preventDefault(),startCoords=coords,valid=!0},cancel:function(){valid=!1},end:function(coords,event){validSwipe(coords)&&scope.$apply(function(){element.triggerHandler(eventName),swipeHandler(scope,{$event:event})})}},pointerTypes)}}])}var ngSwipe=angular.module("swipe",[]);ngSwipe.factory("swipe",[function(){function getCoordinates(event){var originalEvent=event.originalEvent||event,touches=originalEvent.touches&&originalEvent.touches.length?originalEvent.touches:[originalEvent],e=originalEvent.changedTouches&&originalEvent.changedTouches[0]||touches[0];return{x:e.clientX,y:e.clientY}}function getEvents(pointerTypes,eventType){var res=[];return angular.forEach(pointerTypes,function(pointerType){var eventName=POINTER_EVENTS[pointerType][eventType];eventName&&res.push(eventName)}),res.join(" ")}var MOVE_BUFFER_RADIUS=40,MAX_RATIO=.3,POINTER_EVENTS={mouse:{start:"mousedown",move:"mousemove",end:"mouseup"},touch:{start:"touchstart",
move:"touchmove",end:"touchend",cancel:"touchcancel"}};return{bind:function(element,eventHandlers,pointerTypes){var totalX,totalY,startCoords,lastPos,active=!1,isDecided=!1,isVertical=!0;pointerTypes=pointerTypes||["mouse","touch"],element.on(getEvents(pointerTypes,"start"),function(event){startCoords=getCoordinates(event),active=!0,totalX=0,totalY=0,isDecided=!1,isVertical=!0,lastPos=startCoords,eventHandlers.start&&eventHandlers.start(startCoords,event)}),element.on(getEvents(pointerTypes,"cancel"),function(event){active=!1,eventHandlers.cancel&&eventHandlers.cancel(event)}),element.on(getEvents(pointerTypes,"move"),function(event){if(active&&startCoords){var coords=getCoordinates(event);if(totalX+=Math.abs(coords.x-lastPos.x),totalY+=Math.abs(coords.y-lastPos.y),lastPos=coords,!(MOVE_BUFFER_RADIUS>totalX&&MOVE_BUFFER_RADIUS>totalY)){if(!isDecided){var deltaX,deltaY,ratio;deltaX=Math.abs(coords.x-startCoords.x),deltaY=Math.abs(coords.y-startCoords.y),ratio=deltaY/deltaX,MAX_RATIO>ratio?(event.preventDefault(),isVertical=!1):isVertical=!0,isDecided=!0}event.isVertical=isVertical,eventHandlers.move&&eventHandlers.move(coords,event)}}}),element.on(getEvents(pointerTypes,"end"),function(event){active&&(event.isVertical=isVertical,active=!1,eventHandlers.end&&eventHandlers.end(getCoordinates(event),event))})}}}]);try{angular.module("ngTouch")}catch(err){makeSwipeDirective("ngSwipeLeft",-1,!1,"swipeleft"),makeSwipeDirective("ngSwipeRight",1,!1,"swiperight")}makeSwipeDirective("ngSwipeUp",-1,!0,"swipeup"),makeSwipeDirective("ngSwipeDown",1,!0,"swipedown")}(window,window.angular),angular.module("Dktrvamp",["ui.bootstrap","ui.router","ngAnimate","ngtweet","ngSanitize","cfp.hotkeys","swipe"]).config(["$locationProvider","$stateProvider","$provide","$urlRouterProvider",function($locationProvider,$stateProvider,$provide,$urlRouterProvider){"use strict";$provide.decorator("$state",["$delegate",function($delegate){return $delegate.go=function(to,params,options){return $delegate.transitionTo(to,params,angular.extend({reload:!0,inherit:!0,relative:$delegate.$current},options))},$delegate}]),$stateProvider.state("home",{url:"/home/?id/:index",templateUrl:"partials/home.html",controller:"homeCtrl",data:{context:"home"}}).state("home.artist",{url:"/artist/?id/:index",data:{context:"artist"},templateUrl:"partials/artist/artist.html",controller:"ArtistCtrl"}).state("audio",{url:"/audio/?id/:index",templateUrl:"partials/audio.html",controller:"audioCtrl",data:{context:"audio"}}).state("social",{url:"/social/?id/:index",templateUrl:"partials/social.html",controller:"socialCtrl",data:{context:"social"}}).state("about",{url:"/about/?id/:index",templateUrl:"partials/about.html",controller:"aboutCtrl",data:{context:"about"}}).state("contact",{url:"/contact/?id/:index",templateUrl:"partials/contact.html",controller:"contactCtrl",data:{context:"contact"}}).state("policy",{url:"/policy/?id/:index",templateUrl:"partials/policy.html",data:{context:"policy"}}).state("engineering",{url:"/engineering/?id/:index",templateUrl:"partials/engineering.html",data:{context:"engineering"}}),$urlRouterProvider.otherwise("/home"),$locationProvider.html5Mode(!0)}]).run(["$rootScope","$state","$stateParams","Facebook",function($rootScope,$state,$stateParams,Facebook){$rootScope.$state=$state,$rootScope.$stateParams=$stateParams,$state.transitionTo("home"),Facebook.init()}]),angular.module("Dktrvamp").service("ArtistInvoice",["$q","$timeout","$http","Utils",function($q,$timeout,$http,Utils){"use strict";this.artist_results={},this.fetchResults=function(artist,search_engine){if(search_engine=search_engine.toLowerCase()||""){var url,engine={spotify:"https://api.spotify.com/v1/search?q={{artist}}&type=album",soundcloud:"http://ws.audioscrobbler.com/2.0/?method=artist.getSimilar&api_key=95f77e98ba4b1144bcf1b6399c3f05d7",lastfm:"http://ws.audioscrobbler.com/2.0/?method=artist.getTopTracks&artist={{artist}}&api_key=b41174ec667c51018919b2c7924594b8&format=json"};switch(search_engine){case"spotify":url=engine.spotify;break;case"lastfm":url=engine.lastfm;break;case"soundcloud":url=engine.soundcloud;break;default:url=engine.spotify}return _.isString(url)?(url=Utils.replaceTokens(url,{artist:artist},!0),$http.get(url).then($q.resolve)):$q.reject()}}}]),angular.module("Dktrvamp").service("Analytics",["$log","$state","$window",function($log,$state,$window){"use strict";var _is_initialized,_google_analytics=$window.ga;this.initialized=!1,this.init=function(){if(_is_initialized)return void $log.info("Analytics.init - Already Initialized!");$log.info("Analytics.init - Initializing...");var analytics_data={id:"UA-79509363-1"};return analytics_data.id?(_is_initialized=!0,_google_analytics("create",analytics_data.id,"auto"),void $log.info("Analytics.init - Initialized!")):void $log.warn("Analytics.init - ID not found. Google Analytics is not configured.")},this.trackClick=function(tag_or_text,include_state_info){if(_google_analytics){if(!tag_or_text||!_.isString(tag_or_text))return void $log.warn("Analytics.trackClick - Invalid tracking tag, event not tracked.");var element_name=tag_or_text;include_state_info&&(element_name="Current View: "+include_state_info+" Element Text:"+element_name),$window.ga("send","pageview",$state.current.name),$window.ga("send","event",element_name,"click",Date())}}}]),angular.module("Dktrvamp").service("Contact",["$q","$log","$http",function($q,$log,$http){"use strict";return{sendEmail:function(data){var dfd=$q.defer();return $log.info("Contact.sendEmail - Processing...",data),$http({url:"http://www.drvaudio.com/php/sendEmail.php",method:"post",data:data,headers:{"Content-Type":"application/x-www-form-urlencoded"}}).then(function(response){dfd.resolve(),$log.info("Contact.sendEmail - Response...",response)})["catch"](function(){dfd.reject("There was an Error sending the Email!"),$log.error("Contact.sendEmail - Failed...")}),dfd.promise}}}]),angular.module("Dktrvamp").service("Cache",["$log","Utils",function($log,Utils){"use strict";function generateCacheKey(key,strategy){return Utils.replaceTokens(strategy+":{{ publisher }}:{{ environment }}:{{ device_type }}:"+key)}function getStorageForStrategy(strategy){return strategy===_self.STRATEGIES.SESSION?sessionStorage:localStorage}var _self=this;this.STRATEGIES={LOGIN:"LOGIN",SESSION:"SESSION",FOREVER:"FOREVER",FOREVER_USER:"FOREVER:{{user_id}}"},this.get=function(key,strategy){var storage,json;return _.isString(key)&&key.length?(strategy=strategy||_self.STRATEGIES.SESSION,key=generateCacheKey(key,strategy),storage=getStorageForStrategy(strategy),key in storage&&(json=storage.getItem(key)),json?Utils.parseJson(json):null):void $log.warn("Cache.get - Key is empty or not a string.")},this.put=function(key,value,strategy){var storage;return _.isString(key)&&key.length&&!_.isUndefined(value)?(strategy=strategy||_self.STRATEGIES.SESSION,key=generateCacheKey(key,strategy),storage=getStorageForStrategy(strategy),void storage.setItem(key,angular.toJson(value))):void $log.warn("Cache.put - Key is empty or not a string or the value is undefined.")},this.remove=function(key,strategy){var storage;return _.isString(key)&&key.length?(strategy=strategy||_self.STRATEGIES.SESSION,key=generateCacheKey(key,strategy),storage=getStorageForStrategy(strategy),void storage.removeItem(key)):void $log.warn("Cache.remove - Key is empty or not a string or the strategy is undefined.")},this.removeAll=function(strategy){var STRATEGIES=_self.STRATEGIES;if(!(strategy in STRATEGIES))return!1;var storage=getStorageForStrategy(strategy);for(var key in storage)0===key.indexOf(generateCacheKey("",strategy))&&storage.removeItem(key);return!0}}]),angular.module("Dktrvamp").service("Locale",["$http",function($http){"use strict";this.getLocale=function(){return $http.get("locale/gear.json").then(function(response){return response.data})}}]),angular.module("Dktrvamp").service("Facebook",["$window",function($window){"use strict";this.init=function(){$window.fbAsyncInit=function(){$window.FB.init({appId:"1038121762923144",channelUrl:"lib.html",status:!0,cookie:!0,xfbml:!0,version:"v2.7"})},function(d){var js,id="facebook-jssdk",ref=d.getElementsByTagName("script")[0];d.getElementById(id)||(js=d.createElement("script"),js.id=id,js.async=!0,js.src="http://connect.facebook.net/en_US/sdk.js",ref.parentNode.insertBefore(js,ref))}(document)},this.share=function(url,img_url,caption,description){$window.FB.ui({method:"share",display:"popup",mobile_iframe:!0,href:url,link:url,picture:img_url,caption:caption,description:description},function(response){response&&!response.error_message?$window.alert("Posting completed."):$window.alert("Error while posting.")})}}]),angular.module("Dktrvamp").service("FeedService",["$http","$q",function($http,$q){"use strict";this.RSS_FEEDS=[{title:"Music News",id:"feedburner",url:"http://feeds.feedburner.com/thr/music"},{title:"Electronic Music News",id:"edm",url:"http://www.youredm.com/feed/"},{title:"Hip-Hop News",id:"hiphop",url:"http://hiphopwired.com/feed/"},{title:"Moog News",id:"moog",url:"https://www.moogmusic.com/blog/feed"},{title:"Hardware / Software",id:"hard_soft",url:"http://www.tuerkmusic.co.za/index.php/blog/rss"},{title:"New Products",id:"gear",url:"http://feeds.webservice.techradar.com/us/rss/news/audio"},{title:"Other News",id:"other",url:"http://www.sickfacemusic.com/feed.xml"},{title:"Tech Crunch",id:"tech_crunch",url:"http://feeds.feedburner.com/TechCrunch/Google"},{title:"Tech",id:"tech",url:"http://feeds.feedburner.com/TheHollywoodReporter-Technology"},{title:"Music Instruments",id:"musical_instruments",url:"http://www.chucklevins.com/rss.php?type=rss"},{title:"Musicians Information",id:"musicians_information",url:"http://www.musicthinktank.com/blog/rss.xml"},{title:"Producers Tips",id:"producer_tips",url:"http://feeds.feedburner.com/weallmakemusic"},{title:"Musicians Perspective",id:"musicians_perspective",url:"http://www.newrockstarphilosophy.com/feed/"},{title:"Hollywood",id:"hollywood",url:"http://feeds.feedburner.com/thr/news"},{title:"Music Feed",id:"music_1",url:"http://www.synthtopia.com/phpbb2/feed.php"},{title:"Vst News",id:"vst_1",url:"http://feeds.feedburner.com/getthatprosound"},{title:"Vst News II",id:"vst_2",url:"http://feeds.feedburner.com/ProducerSpot?format=xml"},{title:"Roland",id:"vst_3",url:"http://www.rolandus.com/blog/feed/"},{title:"Vintage Gear",id:"vintage_gear",url:"http://feeds.feedburner.com/vintagesynth"}],this.RSS=this.RSS_FEEDS,this.parseFeed=function(url){var dfd=$q.defer();return $http.get("https://api.rss2json.com/v1/api.json",{params:{rss_url:url,api_key:"u0dir3grn8zpbsz1ljwduwtxo1sqn9cw1cpo4uhd"}}).then(dfd.resolve)["catch"](function(er){dfd.reject(er)}),dfd.promise},this.get=function(url){var dfd=$q.defer();return $http({url:"http://www.drvaudio.com/php/getImage.php",method:"post",data:{url:url}}).then(function(res){_.isString(res.data)&&dfd.resolve(res.data)})["catch"](function(er){_.isString(er.data)?dfd.resolve(er.data):dfd.reject(er)}),dfd.promise}}]),angular.module("Dktrvamp").service("Utils",["$compile","$location","$log","$q","$state","$timeout",function($compile,$location,$log,$q,$state,$timeout){"use strict";var _self=this,_tokens={},_regex={valid_chars:/^[\],:{}\s]*$/,valid_escape:/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,valid_tokens:/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,valid_braces:/(?:^|:|,)(?:\s*\[)+/g,comment_lines:/(^\s*\/\/[^\n]*)|([\n]{1,}\s*\/\/[^\n]*)/g};this.createTimer=function(delay_ms){return!_.isFinite(delay_ms)||0>delay_ms?$q.reject():$timeout(angular.noop,delay_ms)},this.emptyCollection=function(collection,fn){var item;if(_.isArray(collection))for(;collection.length;)item=collection.pop(),fn&&fn(item);else if(_.isObject(collection))for(var key in collection)item=collection[key],fn&&fn(item),delete collection[key]},this.extend=function(target){for(var undef,copy,instance,src,len=arguments.length,i=1;len>i;i++){instance=arguments[i];for(var name in instance)if(instance.hasOwnProperty(name)){if(src=target[name],copy=instance[name],target===copy)continue;null===copy?target[name]=null:"object"==typeof copy?target[name]=_self.extend(_.isArray(copy)?[]:{},src,copy):copy!==undef&&(target[name]=copy)}}return target},this.getAttributeOrMetadata=function(obj,key,default_value){return obj&&"object"==typeof obj?key in obj?obj[key]:"metadata"in obj&&key in obj.metadata?obj.metadata[key]:default_value:default_value},this.getNumberInRange=function(value,options){options=options||{},value=parseInt(value,10);var min=options.min||0,max=options.max||100;return _.isNaN(value)?($log.warn("Utils.getNumberInRange - Value is not a number. Using default (if provided)."),options["default"]||value):min>value?min:value>max?max:value},this.getTokenValue=function(key){return _tokens[key]},this.getObjectKey=function(obj,key,default_value){var current_key,current_obj=obj||{};for(key=key.split(".");key.length>0&&"undefined"!=typeof current_obj&&null!==current_obj;)current_key=key.shift(),current_obj=current_obj[current_key];return"undefined"!=typeof current_obj?current_obj:"undefined"!=typeof default_value?default_value:null},this.resolve=function(resolve_value){var dfd=$q.defer();return dfd.resolve(resolve_value),dfd.promise},this.isPlainObject=function(thing){return thing&&"object"==typeof thing&&thing.constructor===Object.prototype.constructor||!1},this.isUrl=function(value){return _.isString(value)?0===value.indexOf("http"):!1},this.parseJson=function(json,remove_comments){return json&&_.isString(json)?(remove_comments&&(json=json.replace(_regex.comment_lines,"")),angular.fromJson(json)):null},this.getQueryString=function(){var query_string={};return _.each($location.search(),function(value,key){if(_.isFinite(value))value=parseInt(value,10);else switch(value.toLowerCase()){case"false":value=!1;break;case"true":value=!0}query_string[key]=value}),query_string},this.renameObjectKey=function(obj,old_key,new_key,transform_fn){if(!_self.isPlainObject(obj)||!old_key||"string"!=typeof old_key)return!1;var val,_key,_old_key=old_key,_new_key=new_key,_obj=obj;for(old_key=old_key.split(".");old_key.length>0;)if(_key=old_key.shift(),0!==old_key.length){if(_obj=_obj[_key],!_self.isPlainObject(_obj))break}else val=_obj[_key],delete _obj[_key];if(_obj=obj,"undefined"!=typeof val&&new_key&&"string"==typeof new_key)for(new_key=new_key.split(".");new_key.length>0;)_key=new_key.shift(),0!==new_key.length?_self.isPlainObject(_obj[_key])?_obj=_obj[_key]:(_obj[_key]={},_obj=_obj[_key]):("function"==typeof transform_fn?val=transform_fn(val,obj,_old_key,_new_key):_self.isPlainObject(transform_fn)&&(val=_self.transformObject(val,transform_fn)),"undefined"!=typeof val&&(_obj[_key]=val));return!0},this.replaceToken=function(string,key,value){return string=string.replace(/\s/g,""),string=string.replace("{{"+key+"}}",_.isUndefined(value)?_self.getTokenValue(key):value)},this.replaceTokens=function(string,tokens,replace_all){return"string"!=typeof string||string.indexOf("{{")<0?string:(string=string.replace(/\s/g,""),replace_all&&(tokens=angular.extend({},tokens,_tokens)),_.each(tokens||_tokens,function(value,key){string=string.replace("{{"+key+"}}",value)}),string)},this.setToken=function(key,value){return key&&value?(_tokens[key]=value.toString(),!0):!1},this.syncCssClass=function(element,css_class,condition){css_class&&element&&element.toggleClass&&element.toggleClass(css_class,!!condition)},this.transformObject=function(obj,map){function _transform(o){var new_key,transform_fn;for(var attr in map)map.hasOwnProperty(attr)&&(new_key=_.isArray(map[attr])?map[attr][0]:map[attr],transform_fn=_.isArray(map[attr])?map[attr][1]:null,_self.renameObjectKey(o,attr,new_key,transform_fn))}if("object"!=typeof obj||"object"!=typeof map)return obj;if(_.isArray(obj))for(var i=obj.length-1;i>=0;--i)_transform(obj[i]);else _transform(obj);return obj},this.toDoubleDigit=function(num){return("number"==typeof num||num instanceof Number)&&1===num.toString().length?"0"+num:num},this.rcms_image=new RegExp("^(http.+/cms/images)/(?:[a-z]{1}/(?:x|[0-9]+)/(?:x|[0-9]+)/)?([0-9a-z]+\\.[a-z]+)$","i"),this.rums_image=new RegExp("^(http.+?)(?:/dyn/.+)?(/[a-f0-9]+/[a-f0-9]+/[^/]+$)","i"),this.getResizedImageUrl=function(url,options){if(url&&"string"==typeof url){options=options||{};var w=parseInt(options.width,10),h=parseInt(options.height,10);if(!w&&!h)return url;var matches,is_cms_url=-1!==url.indexOf("/cms/images");return"ums"!==options.type&&is_cms_url&&(matches=this.rcms_image.exec(url))?matches[1]+(w&&h?"/m/"+w+"/"+h:"/s/"+(w||"x")+"/"+(h||"x"))+"/"+matches[2]:"cms"!==options.type&&!is_cms_url&&(matches=this.rums_image.exec(url))?matches[1]+"/dyn"+(w&&h?"/pa/"+w+"/"+h:"/rs/"+(w||"x")+"/"+(h||"x"))+matches[2]:url}},this.calculateAspectRatioFit=function(src_width,src_height,max_width,max_height){var ratio,ratio_width,ratio_height;return _.isFinite(src_width)&&_.isFinite(src_height)?(ratio_width=_.isFinite(max_width)&&max_width/src_width||null,ratio_height=_.isFinite(max_height)&&max_height/src_height||null,ratio=ratio_width&&ratio_height?Math.min(ratio_width,ratio_height):ratio_width||ratio_height,{width:Math.floor(src_width*ratio),height:Math.floor(src_height*ratio)}):($log.warn("Utils.calculateAspectRatioFit - Invalid parameters. Source width and height are required!"),{})},this.loadImage=function(url,image_element){var dfd;return image_element||(image_element=$(new Image)),url?(dfd=$q.defer(),image_element.load(function(){dfd.resolve(image_element)}).error(function(){dfd.reject(image_element)}).attr("src",url).each(function(){this.complete&&$(this).load()}),dfd.promise):($log.warn("Utils.loadImage - URL is missing or invalid."),$q.reject(image_element))},this.getRandomString=function(length){function getHexChar(){var r=16*Math.random()|0;return r.toString(16)}return length=length&&length>0&&32>=length?length:32,"xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx".substring(0,length).replace(/x/g,getHexChar)},this.compileElement=function(element,scope,child_scope){element&&_.isFunction(element.get)&&element.get(0).childElementCount&&$compile(element.contents())(angular.extend(scope.$new(),child_scope||{}))},this.convertVersionToFloat=function(version,padding){if(!version)return null;version=""+version,padding=padding&&!isNaN(parseInt(padding,10))?padding:4;var decimal="";return _.each(version.split("."),function(part){_.each(part.split("-"),function(num){num=parseInt(num,10),num=isNaN(num)?9999:num,decimal+=_self.padWithZeros(num,padding)})}),parseFloat("0."+decimal)},this.padWithZeros=function(number,length){for(var str=""+number;str.length<length;)str="0"+str;return str},this.getCurrentSectionStateData=function(){var parts=$state.current.name.split("."),root_section=parts[0]+"."+parts[1],current_state=$state.get(root_section)||{};return current_state.data||(current_state.data={}),current_state.data}}]),angular.module("Dktrvamp").service("RssRibbon",["$http","$q","FeedService",function($http,$q,FeedService){"use strict";this.FEEDS=FeedService.RSS,this.getRssFeeds=function(){var promise,RSS_FEEDS=FeedService.RSS_FEEDS,dfd=$q.defer(),feeds=[];return promise=FeedService.parseFeed(RSS_FEEDS[0].url).then(function(response){var data=response&&response.data;return data&&feeds.push(data),FeedService.parseFeed(RSS_FEEDS[3].url).then(function(response){var data=response&&response.data;data&&feeds.push(data)})["finally"](function(){dfd.resolve(feeds)})}),dfd.promise},this.filterFeeds=function(){console.log}}]),angular.module("Dktrvamp").directive("artistApi",function(){"use strict";return{replace:!0,controller:["$http","$log","$scope",function($http,$log,$scope){$scope.model={artist:null},$scope.engine=[{id:1,search:"Spotify"},{id:3,search:"LastFm"}],$scope.selected=$scope.engine[0],$scope.artists=[]}],restrict:"A",templateUrl:"directive/artist-api.html"}}),angular.module("Dktrvamp").directive("artistContent",["$log","ArtistInvoice",function($log,ArtistInvoice){function linkFn(scope){function load(response){var top_tracks,data=response.data,result=data&&data.toptracks||data.albums;_model.items=result&&result.items||{},top_tracks="LastFm"===_model.type?result&&result.track:[],top_tracks&&top_tracks.length&&_.each(top_tracks,function(item){_.each(item.image,function(image){var value=image&&image[Object.keys(image)[0]];image.url=value})}),_model.toptracks=top_tracks}function onSearchEngineChanged(new_val){new_val&&(_model.items=[]),console.log("Search Enigne changed to: ",new_val),_model.type=new_val}var _model={};scope.model=_model,scope.searchArtist=function(){var promise=ArtistInvoice.fetchResults(_model.artist,scope.type);promise.then(load)["catch"](function(){$log.info("Dir.ArtistContent - failed to fetch data from the content directive")})},scope.$watch("type",onSearchEngineChanged)}return{scope:{type:"=?"},replace:!0,restrict:"A",link:linkFn,templateUrl:"directive/artist-content/artist-content.html"}}]),angular.module("Dktrvamp").directive("homeFooter",function(){"use strict";var linkFn=function(scope){scope.items=[{title:"Engineering",to_state:"engineering"},{title:"Contact",to_state:"contact"},{title:"Privacy Policy",to_state:"policy"}],$(".popover").mouseover(function(){$(this).hide()})};return{templateUrl:"directive/footer/home-footer.html",replace:!0,link:linkFn}}),angular.module("Dktrvamp").directive("gearSlide",["$http","$interval","hotkeys","Utils",function($http,$interval,hotkeys,Utils){var linkFn=function(scope,element){function update(){var promise=$http.get("locale/studio-gear.json");promise.then(function(response){_items=response.data,_model.item=_items[_index]}).then(getItemAtIndex)["catch"](function(){element.remove()}),_slide_interval_promise=$interval(getItemAtIndex,6e4)}function getItemAtIndex(direction){var items_length=_items.length-1;_index="left"===direction?0>=_index?items_length:_index-1:_index>=items_length?0:_index+1,_model.item=_items[_index],_model.should_display=!1,Utils.createTimer(300).then(function(){_model.should_display=!0})}function addHotkeysForScope(){var createCallback=function(direction){return function(event){event.preventDefault(),getItemAtIndex(direction),reset()}};hotkeys.bindTo(scope).add({combo:"left",allowIn:["INPUT"],callback:createCallback("left")}).add({combo:"right",allowIn:["INPUT"],callback:createCallback("right")})}function reset(){_slide_interval_promise&&($interval.cancel(_slide_interval_promise),_slide_interval_promise=null)}var _model={should_display:!1,item:{},image:""},_items=[],_index=0,_slide_interval_promise=null;scope.model=_model,scope.onButtonClicked=function(direction){reset(),getItemAtIndex(direction)},update(),addHotkeysForScope()};return{replace:!0,restrict:"A",scope:{},templateUrl:"directive/gear/gear.html",link:linkFn}}]),angular.module("Dktrvamp").directive("instagram",["$timeout","$http",function($timeout,$http){"use strict";function linkFn(scope){function instaArtist(){$http({url:"https://api.instagram.com/v1/media/client_id=956b500ec10745f395e4eddc267bf291/likes?access_token=202159144.956b500.f1c1ca50f73d44aa8dc252406b8bb94e",method:"get"}).then(function(response){console.log("instaArtist()",response,response&&response.data),scope.artists=response.data})["catch"](function(){console.log("failed---",arguments)})}scope.model={artist:null,should_slide:!1,show_caption:!1,artist_caption_text:null},scope.insta_artists=null,scope.artists=[],scope.onClick=function(){$timeout(function(){scope.model.should_slide=!0},4e3)},scope.showCaption=function(index){scope.model.show_caption=!0,scope.model.should_slide=!0,scope.model.artist_caption_text=scope.artists[index]},instaArtist()}return{restrict:"A",templateUrl:"directive/instagram.html",link:linkFn}}]).animation(".slide-side",function(){return{enter:function(element,doneFn){element.css("opacity",.5).animate({opacity:1},1250,"ease-in",doneFn)}}}),angular.module("Dktrvamp").directive("navBar",function(){var linkFn=function(scope){scope.menu_bar=[{title:"Home",state:"home",index:1},{title:"Audio",state:"audio",index:2},{title:"Social",state:"social",index:3},{title:"About",state:"about",index:4}]};return{replace:!0,restrict:"A",templateUrl:"directive/nav-bar/nav-bar.html",link:linkFn}}),angular.module("Dktrvamp").directive("loading",["$window",function($window){"use strict";return{replace:!0,restrict:"E",templateUrl:"directive/overlay/loading.html",controller:["$scope",function($scope){$scope.window=$window}]}}]),angular.module("Dktrvamp").directive("playlist",["$window","$http","$log","$uibModal","$timeout","Utils",function($window,$http,$log,$uibModal,$timeout,Utils){"user strict";return{link:function(scope){function getLocaleString(){var items,promise=$http.get("locale/tracks.json");promise.then(function(response){items=response.data;var width="w_"+($window.is_mobile?300:1e3);_.each(items,function(track){track.waveform=Utils.replaceToken(track.waveform,"width",width)}),scope.tracks=_tracks=items.concat(),_model.source=_tracks[0].src})["catch"](function(){$log.warn("Playlist.getLocaleString - FAILED")})}function initMp3Player(){_audio_player&&(_audio_player.crossOrigin="anonymous",updateVisualizer())}function updateVisualizer(){$window.player=_audio_player,$window.AudioContext=$window.webkitAudioContext||$window.AudioContext,context=new AudioContext,source=context&&context.createMediaElementSource(_audio_player),analyser=context&&context.createAnalyser(),canvas=document.getElementById("analyser_render"),ctx=canvas&&canvas.getContext("2d"),source.connect(analyser),analyser.connect(context.destination),frameLooper()}function frameLooper(){$window.requestAnimationFrame(frameLooper),fbc_array=new Uint8Array(analyser.frequencyBinCount),analyser.getByteFrequencyData(fbc_array),ctx.clearRect(0,0,canvas.width,canvas.height),ctx.fillStyle=0===_current_track?"#FF4B4B":1===_current_track?"#8EFFFF":2===_current_track?"#0FFF3C":3===_current_track?"#CEFF45":4===_current_track?"#8EFFFF":"#0992cc",bars=5e3;for(var i=0;bars>i;i++)bar_x=1*i,bar_width=1,bar_height=-(fbc_array[i]/2),ctx.fillRect(bar_x,canvas.height,bar_width,bar_height)}function setWaveformOverlayWidth(position){var max_left_position,width;_.isFinite(position)&&(max_left_position=Utils.getNumberInRange((position/_current_track_duration*100).toFixed(1),{min:0,max:100,"default":0}),_waveform_width=Math.ceil(_waveform_width),width=_waveform_width*(Math.ceil(max_left_position)/100),width=Math.floor(width),console.log(_waveform_width,width),$(".overlay-wave").css({width:width+"px"}))}function updateTimeline(){setWaveformOverlayWidth(Math.ceil(this.currentTime))}function onWindowResize(){_waveform_width=$(".waveform").width()}var _waveform_width,canvas,ctx,source,context,analyser,fbc_array,bars,bar_x,bar_width,bar_height,_model={length:null,title:null,source:null,playing_item:{}},_tracks=[],_audio_player=$("#audioplayer")[0],_current_track=0,_current_track_duration=-1,_window=$($window);scope.model=_model,scope.onPlayToggle=function(event,index){if(event.stopPropagation(),_model.playing_item&&_model.playing_item.index===index)return _audio_player.pause(),void(_model.playing_item={});var track=_tracks[index];_model.playing_item={index:index},_current_track=index,_audio_player.pause(),_audio_player.currentTime=0,_current_track_duration=Math.ceil(_audio_player.duration),_model.source=track&&track.src||_model.source,_waveform_width=$(".waveform").width(),$timeout(function(){_audio_player.paused&&_audio_player.play()},150)},getLocaleString(),initMp3Player(),_window.on("resize",onWindowResize),$(_audio_player).on("timeupdate",updateTimeline),scope.$on("$destroy",function(){_window.unbind("resize",onWindowResize),$(_audio_player).off("timeupdate",updateTimeline)})},restrict:"E",templateUrl:"directive/playlist/playlist.html"}}]),angular.module("Dktrvamp").directive("rssFeed",["$state","$location","$interval","$http","$timeout","$window","FeedService","hotkeys","Utils",function($state,$location,$interval,$http,$timeout,$window,FeedService,hotkeys,Utils){"use strict";var linkFn=function(scope){function getRssFeed(){$window.is_loading=!0;var feed=scope.news||FeedService.RSS_FEEDS[0],url=feed&&feed.url||null;FeedService.parseFeed(url).then(function(response){_items=response&&response.data.items,_model.feed=_items[_index],_model.should_display=!0,_model.active_slide_index=_index,_model.slides=_items,$state.go($state.current.name,{id:feed.id,index:_index}).then(function(){_model.state=$location.absUrl()})})["finally"](function(){$window.is_loading=!1}),_slide_interval_promise=$interval(getItemAtIndex,6e4)}function getItemAtIndex(direction){var items_length=_items.length-1;_index="left"===direction?0>=_index?items_length:_index-1:_index>=items_length?0:_index+1,_model.feed=_items[_index],_model.active_slide_index=_index,_model.should_display=!1;var feed=scope.news||FeedService.RSS_FEEDS[0];$state.go($state.current.name,{id:feed.id,index:_index}).then(function(){_model.state=$location.absUrl()}),Utils.createTimer(100).then(function(){_model.should_display=!0})}function addHotkeysForScope(){var createCallback=function(direction){return function(event){event.preventDefault(),getItemAtIndex(direction),reset()}};hotkeys.bindTo(scope).add({combo:"left",allowIn:["INPUT"],callback:createCallback("left")}).add({combo:"right",allowIn:["INPUT"],callback:createCallback("right")})}function reset(){_slide_interval_promise&&($interval.cancel(_slide_interval_promise),_slide_interval_promise=null)}function scroll(int){if(!(_.isFinite(int)&&6>=int)){var delay=500,id="#"+_index,ind=$(id),position=ind.hasClass("ng-scope")&&ind.position(),left=position&&position.left;return left?void $timeout(function(){$(".indicators").animate({scrollLeft:left},delay)}):void $timeout(scroll,delay)}}function onDestroy(){reset(),$state.go($state.current.name,{id:null,index:null})}var _params=$state.params,_items=[],_index=parseInt(_params.index,10)||0,_slide_interval_promise=null,_model={feed:{},image_thumbnail:null,should_display:!1,active_slide_index:0,is_mobile:$window.is_mobile,slides:[],state:""};scope.model=_model,scope.onButtonClicked=function(direction){reset(),getItemAtIndex(direction)},scope.onIndicatorClicked=function(index){reset(),_model.feed=_items[index],_model.active_slide_index=_index=index,$state.go($state.current.name,{index:_index}).then(function(){_model.state=$location.absUrl()})},getRssFeed(),addHotkeysForScope(),scope.$on("$destroy",onDestroy),scope.$watch("model.active_slide_index",scroll)};return{scope:{news:"=?"},restrict:"A",templateUrl:"directive/rss-feed/rss-feed.html",link:linkFn}}]),angular.module("Dktrvamp").directive("verticalMenu",["$state","$uibModal","FeedService","Utils",function($state,$uibModal,FeedService,Utils){"use strict";function linkFn(scope){var _tabs=FeedService.RSS_FEEDS,artist_search_template=['<button class="submit-button nav-button active" ','data-ng-click="onDismiss()">Close</button>',"<div data-artist-api></div>"].join(""),rss_feed_template=['<button class="submit-button nav-button active" ','data-ng-click="onOpenClose();onDismiss()">Close</button>','<div data-rss-feed data-news="model.news"></div>'].join(""),_model={news:null,title:"Top News",tabs:_tabs,is_open:!1,is_closing:!1,show_indicator:!0},_modal_promise=null;scope.model=_model,scope.onClicked=function(event,tab){event&&event.stopPropagation();var template="";_model.news=tab&&tab,scope.onOpenClose(),template=tab&&_.findWhere(_tabs,{id:tab.id})?rss_feed_template:artist_search_template,_modal_promise=$uibModal.open({windowClass:"special-features-dialog-container",scope:scope,template:template,controller:function($scope,$uibModalInstance){$uibModalInstance.opened.then(function(){_model.show_indicator=!1}),$uibModalInstance.result["catch"](function(){_model.show_indicator=!$state.includes("home")})["finally"](function(){_modal_promise=null}),$scope.onDismiss=$uibModalInstance.dismiss}})},scope.onMouseEvent=function(mouse_event){_model.is_open="in"===mouse_event,_model.is_open&&(_model.is_closing=!0,Utils.createTimer(1e3)["finally"](function(){_model.is_closing=!1}))},scope.onOpenClose=function(){
_model.is_open=!_model.is_open},function(){var params=$state.params,id=params&&params.id;id&&scope.onClicked(null,{id:params.id})}(),scope.$on("$stateChangeSuccess",function(e,newState){_model.show_indicator=newState&&"home"!==newState.name,_model.is_open=!1})}return{replace:!0,restrict:"E",templateUrl:"directive/vertical-menu/vertical-menu.html",link:linkFn}}]).animation(".slide-side",function(){return{enter:function(element,doneFn){element.css("opacity",.5).animate({opacity:1},1250,"ease-in",doneFn)}}}),angular.module("Dktrvamp").directive("ngClick",["$location","Analytics",function($location,Analytics){"use strict";return{restrict:"A",link:function(scope,element){function onClick(event){var tag_name=event&&$(event.target).text();Analytics.trackClick(tag_name,$location.url())}scope.$on("$destroy",function(){element.off("click",onClick)}),element.on("click",onClick)}}}]),angular.module("Dktrvamp").directive("socialShare",["$location","$timeout","$window","Facebook",function($location,$timeout,$window,Facebook){"user strict";function link(scope){function update(){return $window.is_mobile?void(_model.should_show=!0):(_model.should_show=!1,_timeout_promise=$timeout(angular.noop,500),void _timeout_promise["finally"](function(){_model.should_show=!0,$timeout.cancel(_timeout_promise),_timeout_promise=null}))}function getImageUrl(){var img,content=scope.parent_model.feed.content,url="http://res.cloudinary.com/www-drvaudio-com/image/upload/v1472971318/drv-logo_odaevq.png";return content?(img=angular.element(content).find("img"),img&&img[0]&&img[0].src||url):url}var _model={should_show:!1},_timeout_promise=null;scope.model=_model,scope.parent_model=scope.$parent.$parent.model,scope.parent_model={state:scope.parent_model.state||$location.absUrl(),feed:scope.parent_model.feed||{title:"Drvaudio.com Home Page",contentSnippet:"😡🎼🎧🎹🎤"}},scope.onFbClick=function(){Facebook.share(scope.parent_model.state,getImageUrl(),scope.parent_model.feed.title,scope.parent_model.feed.contentSnippet)},update()}return{link:link,scope:!0,replace:!0,restrict:"E",templateUrl:"directive/social-share/social-share.html"}}]),angular.module("Dktrvamp").directive("verticalRibbon",["RssRibbon",function(RssRibbon){"use strict";var linkFn=function(scope){function getRssFeed(){RssRibbon.getRssFeeds().then(function(data){data&&data.length&&(model.ribbons=data)})}var model={};scope.model=model,getRssFeed()};return{scope:{},restrict:"A",template:'<div id="VerticalRibbon"><div ng-repeat="ribbon in model.ribbons">    <div data-rss-ribbon ribbon="ribbon"></div></div> </div>',link:linkFn}}]),angular.module("Dktrvamp").directive("rssRibbon",function(){"use strict";var linkFn=function(scope){scope.feeds=[],scope.$watch("ribbon",function(){scope.feeds=scope.ribbon&&scope.ribbon.items})};return{scope:{ribbon:"=?"},restrict:"A",templateUrl:"directive/rss-ribbon/rss-ribbon.html",link:linkFn}}),angular.module("Dktrvamp").directive("rssTile",function(){"use strict";var linkFn=function(){};return{replace:!0,scope:{item:"=?"},restrict:"A",template:'<div id="RssTile"> <div class="date" data-ng-bind="item.publishedDate"></div><br><img data-ng-if="image_thumbnail" class="image-thumbnail" width="360" height="240" data-ng-src="{{image_thumbnail}}"/><br><a class="title" data-ng-href="{{item.link}}" target="_blank">{{item.title}}</a><br> <p class="contentSnippet fade-in fade-out" data-ng-bind-html="item.content"></p><br> </div>',link:linkFn}}),angular.module("Dktrvamp").directive("twitterFeed",function(){"use strict";return{restrict:"A",templateUrl:"directive/twitter/twitter-feed.html"}}),angular.module("Dktrvamp").directive("soundcloudNewTrack",function(){"use strict";return{replace:!0,restrict:"A",templateUrl:"directive/soundcloud/soundcloud-new-track.html",link:function(){}}}),angular.module("Dktrvamp").directive("wave",function(){"use strict";return{replace:!0,restrict:"A",templateUrl:"directive/visual-animation/wave.html",controller:["$scope","$element",function($scope,$element){function load(){for(var i=0;_max_width>i;i++){var color="#"+Math.floor(16777215*Math.random()).toString(16);_delay-=5,$scope.bars.push({id:i,color:color,height:_height,delay:_delay})}}var _window_width=parseInt($($element).css("width"),10),_max_width=_window_width,_delay=0,_height=30;$scope.bars=[],load(),$scope.$on("$destroy",function(){$scope.bars=[]})}]}}),angular.module("Dktrvamp").controller("gearCtrl",["$uibModalInstance","$scope","Locale","Utils",function($uibModalInstance,$scope,Locale,Utils){function loadDataForTab(){var http_promise;http_promise=Locale.getLocale(),http_promise.then(function(result){var item,gears=result;item=Utils.getAttributeOrMetadata(gears,_selected_tab)[0],_model.image=item.image,_model.content=item.content,_model.others=item.others})}var _model={},_selected_tab=$scope.$parent.selected_tab.toLowerCase();$scope.model=_model,$scope.onClose=function(){$uibModalInstance.dismiss()},loadDataForTab()}]),angular.module("Dktrvamp").controller("confirmationCtrl",["$scope",function($scope){$scope.model=$scope.$parent.model}]),angular.module("Dktrvamp").controller("purchaseCtrl",["$modalInstance","$scope","$state",function($modalInstance,$scope,$state){"use strict";$state&&console.log($state),$scope.onDismiss=function(){$modalInstance.dismiss(),$modalInstance.close()}}]),angular.module("Dktrvamp").controller("ArtistCtrl",function(){}),angular.module("Dktrvamp").controller("audioCtrl",function(){}),angular.module("Dktrvamp").controller("contactCtrl",["$scope","$state","$uibModal","Contact",function($scope,$state,$uibModal,Contact){"user strict";var _model={is_loading:!1,submit:!1,is_error:!1,error_message:""};$scope.model=_model,$scope.onSubmitClicked=function(){_model.submit=!0,_model.is_loading=!0,Contact.sendEmail($scope.model)["catch"](function(error_msg){_model.is_error=!0,_model.error_message=error_msg,_model.is_loading=!1}).then(function(){var dialog,promise;_model.is_error||(dialog=$uibModal.open({windowClass:"confirmation-dialog-container",scope:$scope,templateUrl:"modals/confirmation.html",controller:"confirmationCtrl"}),promise=dialog.result,promise.then(function(){$state.go("home")},function(){$state.go("home")})["finally"](function(){$scope.model={},_model.is_loading=!1,_model.is_error=!1}))})}}]),angular.module("Dktrvamp").controller("aboutCtrl",["$scope","$http",function($scope,$http){function getAboutLocale(){$http.get("locale/about.json").then(function(response){$scope.model.content=response.data&&response.data.info})["catch"](function(){console.log("getAboutLocale.Failed -----")})["finally"](function(){})}$scope.model={content:{}},getAboutLocale()}]),angular.module("Dktrvamp").controller("homeCtrl",function(){}),angular.module("Dktrvamp").controller("socialCtrl",function(){}),angular.module("Dktrvamp").controller("MainCtrl",["$scope","$state","$window","Analytics","Utils",function($scope,$state,$window,Analytics,Utils){"use strict";function onStateChangeSuccess(event,new_state,new_params,old_state){if(new_state!==old_state){new_state=new_state||$state.current;var data=new_state.data||{};$scope.context=data.context||"",new_state&&!old_state&&($window.is_loading=!0,Utils.createTimer(1e3)["finally"](function(){$window.is_loading=!1}))}}function onWindowDragDrop(event){event.preventDefault()}function onDestroy(){$($window).off("dragover",onWindowDragDrop),$($window).off("drop",onWindowDragDrop)}$scope.model={},$scope.context=null,function(){/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)&&($scope.model.is_mobile=!0,$window.is_mobile=!0),Analytics.initialized===!1&&Analytics.init()}(),onStateChangeSuccess(null,$state.current),$scope.$on("$stateChangeSuccess",onStateChangeSuccess),$scope.$on("$destroy",onDestroy),$($window).on("dragover",onWindowDragDrop),$($window).on("drop",onWindowDragDrop)}]),angular.module("Dktrvamp").animation(".fade-in",function(){return{enter:function(element,doneFn){$(element).css("opacity",0).animate({opacity:1},450,"linear",doneFn)}}}).animation(".fade-out",function(){return{leave:function(element,doneFn){$(element).animate({opacity:0},450,"linear",doneFn)}}}),angular.module("Dktrvamp").filter("trusted",["$sce",function($sce){return function(url){return $sce.trustAsResourceUrl(url)}}]).filter("cut",function(){return function(value,wordwise,max,tail){if(!value)return"";if(max=parseInt(max,10),!max)return value;if(value.length<=max)return value;if(value=value.substr(0,max),wordwise){var lastspace=value.lastIndexOf(" ");-1!==lastspace&&(("."===value.charAt(lastspace-1)||","===value.charAt(lastspace-1))&&(lastspace-=1),value=value.substr(0,lastspace))}return value+(tail||" …")}}),angular.module("Dktrvamp").filter("escape",function(){return window.encodeURIComponent});var responsiveSwitch=function(){function s(){var v=document.querySelector('meta[name="viewport"]');return void 0==v.getAttribute(l)&&v.setAttribute(l,v.getAttribute(d)),v.getAttribute(d)==v.getAttribute(l)?(document.cookie=a+"=true;path=/",document.documentElement.clientWidth!=window.innerWidth?document.location.href=i():v.setAttribute(d,"width="+h+"px, initial-scale="+document.documentElement.clientWidth/h)):(document.cookie=a+"=false;path=/;expires=Thu, 01 Jan 1970 00:00:01 GMT",document.documentElement.clientWidth!=window.innerWidth?document.location.href=i():v.setAttribute(d,v.getAttribute(l))),!1}function m(){for(var w=document.querySelectorAll("."+t),x=0;x<w.length;x++){var v=w[x];void 0!=v&&(n(v,f),n(v,p),n(v,b),n(v,u),k()?(j(v,f),j(v,u),v.innerHTML=v.getAttribute(e)):document.documentElement&&(document.documentElement.clientWidth<h||"true"==v.getAttribute(o))?(j(v,p),j(v,u),v.innerHTML=v.getAttribute(g)):(j(v,b),v.innerHTML=""),c||v.addEventListener("click",function(y){y=y||window.event,y.preventDefault(),q()},!1))}c=!0}function q(){s(),m()}function r(){k()&&s(),document.addEventListener&&(document.addEventListener("DOMContentLoaded",m,!1),document.addEventListener("orientationchange",m,!1),window.addEventListener("resize",m,!1))}function k(){return document.cookie.search(a+"=true")>-1}function j(w,v){w.className+=" "+v}function n(w,v){w.className=" "+w.className+" ",w.className=w.className.replace(" "+v+" ","")}function i(){var v=new Date,w=v.getTime();return document.location.protocol+"//"+document.location.host+document.location.pathname+(window.location.search?window.location.search+"&":"?")+"rsTimestamp="+w+document.location.hash}var h=parseInt(window.responsiveSwitchBreakpoint)||1024,a="ResponsiveSwitch",d="content",l="data-rs",g="data-link-desktop",e="data-link-responsive",o="data-always-visible",t="rs-link",p="rs-link-to-desktop",f="rs-link-to-responsive",b="rs-link-inactive",u="rs-link-active",c=!1;return r(),{toggle:q}}();!function(i,s,o,g,r,a,m){i.GoogleAnalyticsObject=r,i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date,a=s.createElement(o),m=s.getElementsByTagName(o)[0],a.async=1,a.src=g,m.parentNode.insertBefore(a,m)}(window,document,"script","//www.google-analytics.com/analytics.js","ga"),angular.module("Dktrvamp").run(["$templateCache",function($templateCache){"use strict";$templateCache.put("partials/about.html","<div id=About><div class=about-headers><h1>About</h1><h3 class=name data-ng-bind-html=model.content.name></h3><h5 class=name data-ng-bind-html=model.content.artist_name></h5><span class=age data-ng-bind-html=model.content.age></span> <span class=ethnicity data-ng-bind-html=model.content.ethnicity></span> <span class=location data-ng-bind-html=model.content.location></span><div class=image data-ng-bind-html=model.content.image></div><p class=description data-ng-bind-html=\"model.content.about.join('')\"></p></div></div>"),$templateCache.put("partials/artist/artist.html",""),$templateCache.put("partials/audio.html","<div id=Audio><playlist></playlist></div>"),$templateCache.put("partials/contact.html",'<div id=Contact><h1>Contact</h1><form name=form class=form-group method=post role=form data-ng-submit="form.$valid && onSubmitClicked()" novalidate><h4>Send an Email!</h4><div class=invalid-form-message data-ng-if=model.is_error>{{ model.error_message }}</div><div class=invalid-form-message data-ng-if="form.$invalid && form.$dirty && !model.is_error">Please enter the required fields!</div><label for=name>Name: <span ng-bind=name></span></label><input id=name name=name class=form-control placeholder=Name autofocus data-ng-model=model.name required><label for=email data-ng-class="{\n                \'invalid\': email.$dirty  && email.$invalid\n            }">Email address: <span ng-bind=email></span></label><input id=email type=email name=email data-ng-model=model.email placeholder=Email class=form-control required><label for=message>Message:</label><textarea id=message name=message class=form-control data-ng-model=model.message placeholder="Please leave a comment!" rows=5 cols=20 required></textarea><br><button type=submit value=submit name=submit class=submit-button data-ng-disabled="form.$dirty && form.$invalid ||\n            (!model.email && !model.name && !model.message)">Submit</button></form><data-loading data-ng-if=model.is_loading></data-loading></div>'),$templateCache.put("partials/engineering.html","<div id=Engineering><h1>This Page is not Yet Available</h1><div data-gear-slide></div></div>"),$templateCache.put("partials/home.html",'<div id=Home><data-social-share></data-social-share><div data-wave></div><div class=vertical-ribbon vertical-ribbon></div><button class="submit-button rs-link" data-ng-if=model.is_mobile data-ng-click="model.is_mobile = !model.is_mobile" data-link-desktop="Switch to desktop version">Switch to desktop version</button><div class=home-image></div></div>'),$templateCache.put("partials/policy.html","<div id=Policy class=shaddow><h3>www.drvaudio.com</h3><h4>Privacy Policy</h4><span>This privacy policy has been compiled to better serve those who are concerned with how their 'Personally identifiable information' (PII) is being used online.<br>PII, as used in US privacy law and information security, is information that can be used on its own or with other information to identify, contact, or locate a single person, or to identify an individual in context.<br>Please read our privacy policy carefully to get a clear understanding of how we collect, use, protect or otherwise handle your Personally Identifiable Information in accordance with our website.</span> <span class=policy-question>What personal information do we collect from the people that visit our blog, website or app?</span><p class=policy-answer>When ordering or registering on our site, as appropriate, you may be asked to enter your Geolocation or other details to help you with your experience.</p><span class=policy-question>When do we collect information?</span><p class=policy-answer>We collect information from you when you or enter information on our site.</p><b>Navigating</b> <span class=policy-question>How do we use your information?</span><p class=policy-answer>We may use the information we collect from you when you register, make a purchase, sign up for our newsletter, respond to a survey or marketing communication, surf the website, or use certain other site features in the following ways:<ul><li>To personalize user's experience and to allow us to deliver the type of content and product offerings in which you are most interested.</li><li>To improve our website in order to better serve you.</li><li>To allow us to better service you in responding to your customer service requests.</li><li>To ask for ratings and reviews of services or products</li></ul></p><span class=policy-question>How do we protect visitor information?</span> <span class=policy-answer>We do not use vulnerability scanning and/or scanning to PCI standards. We only provide articles and information. We never ask for credit card numbers. We use regular Malware Scanning. Your personal information is contained behind secured networks and is only accessible by a limited number of persons who have special access rights to such systems, and are required to keep the information confidential. In addition, all sensitive/credit information you supply is encrypted via Secure Socket Layer (SSL) technology. We implement a variety of security measures when a user enters, submits, or accesses their information to maintain the safety of your personal information. All transactions are processed through a gateway provider and are not stored or processed on our servers.</span> <span class=policy-question>Do we use 'cookies'?</span> <span class=policy-answer>Yes. Cookies are small files that a site or its service provider transfers to your computer's hard drive through your Web browser (if you allow) that enables the site's or service provider's systems to recognize your browser and capture and remember certain information. For instance, we use cookies to help us remember and process the items in your shopping cart. They are also used to help us understand your preferences based on previous or current site activity, which enables us to provide you with improved services. We also use cookies to help us compile aggregate data about site traffic and site interaction so that we can offer better site experiences and tools in the future.<br><b><i>We use cookies to:</i><b><ul><li>• Compile aggregate data about site traffic and site interactions in order to offer better site experiences and tools in the future. We may also use trusted third-party services that track this information on our behalf.</li></ul>You can choose to have your computer warn you each time a cookie is being sent, or you can choose to turn off all cookies. You do this through your browser (like Internet Explorer) settings. Each browser is a little different, so look at your browser's Help menu to learn the correct way to modify your cookies. If you disable cookies off, some features will be disabled It won't affect the user's experience that make your site experience more efficient and some of our services will not function properly.</b></b></span> <b><i>Third-party disclosure</i></b> <span class=policy-answer>We do not sell, trade, or otherwise transfer to outside parties your personally identifiable information unless we provide users with advance notice. This does not include website hosting partners and other parties who assist us in operating our website, conducting our business, or serving our users, so long as those parties agree to keep this information confidential. We may also release information when it's release is appropriate to comply with the law, enforce our site policies, or protect ours or others' rights, property or safety. However, non-personally identifiable visitor information may be provided to other parties for marketing, advertising, or other uses.</span> <b><i>Third-party links</i></b> <span class=policy-answer>Occasionally, at our discretion, we may include or offer third-party products or services on our website. These third-party sites have separate and independent privacy policies. We therefore have no responsibility or liability for the content and activities of these linked sites. Nonetheless, we seek to protect the integrity of our site and welcome any feedback about these sites.</span> <b><i>Google</i></b> Google's advertising requirements can be summed up by Google's Advertising Principles. They are put in place to provide a positive experience for users. <a href=\"https://support.google.com/adwordspolicy/answer/1316548?hl=en\" target=_blank>https://support.google.com/adwordspolicy/answer/1316548?hl=en</a><br>We use Google AdSense Advertising on our website.<br>Google, as a third-party vendor, uses cookies to serve ads on our site. Google's use of the DART cookie enables it to serve ads to our users based on previous visits to our site and other sites on the Internet. Users may opt-out of the use of the DART cookie by visiting the Google Ad and Content Network privacy policy.<br><ul><b>We have implemented the following:</b><li>Demographics and Interests Reporting</li></ul><br>We along with third-party vendors, such as Google use first-party cookies (such as the Google Analytics cookies) and third-party cookies (such as the DoubleClick cookie) or other third-party identifiers together to compile data regarding user interactions with ad impressions and other ad service functions as they relate to our website.<br><b>Opting out:</b><br>Users can set preferences for how Google advertises to you using the Google Ad Settings page. Alternatively, you can opt out by visiting the Network Advertising initiative opt out page or permanently using the Google Analytics Opt Out Browser add on.<br>California Online Privacy Protection Act<br>CalOPPA is the first state law in the nation to require commercial websites and online services to post a privacy policy. The law's reach stretches well beyond California to require a person or company in the United States (and conceivably the world) that operates websites collecting personally identifiable information from California consumers to post a conspicuous privacy policy on its website stating exactly the information being collected and those individuals with whom it is being shared, and to comply with this policy.<br>- See more at: <a href=http://consumercal.org/california-online-privacy-protection-act-caloppa/#sthash.0FdRbT51.dpuf>http://consumercal.org/california-online-privacy-protection-act-caloppa/#sthash.0FdRbT51.dpuf</a><br>According to CalOPPA we agree to the following: Users can visit our site anonymously. Once this privacy policy is created, we will add a link to it on our home page or as a minimum on the first significant page after entering our website. Our Privacy Policy link includes the word 'Privacy' and can be easily be found on the page specified above.<ul><b>Users will be notified of any privacy policy changes:</b><li>On our Privacy Policy Page</li><b>Users are able to change their personal information:</b><li>By logging in to their account</li></ul><br>How does our site handle do not track signals? We don't honor do not track signals and do not track, plant cookies, or use advertising when a Do Not Track (DNT) browser mechanism is in place. We don't honor them because: There is no benefit.<br>Does our site allow third-party behavioral tracking? It's also important to note that we allow third-party behavioral tracking<br>COPPA (Children Online Privacy Protection Act)<br>When it comes to the collection of personal information from children under 13, the Children's Online Privacy Protection Act (COPPA) puts parents in control. The Federal Trade Commission, the nation's consumer protection agency, enforces the COPPA Rule, which spells out what operators of websites and online services must do to protect children's privacy and safety online.<br>We do not specifically market to children under 13.<br>Fair Information Practices<br>The Fair Information Practices Principles form the backbone of privacy law in the United States and the concepts they include have played a significant role in the development of data protection laws around the globe. Understanding the Fair Information Practice Principles and how they should be implemented is critical to comply with the various privacy laws that protect personal information.<br><ul><b>In order to be in line with Fair Information Practices we will take the following responsive action, should a data breach occur: We will notify the users via in-site notification</b><li>Within 1 business day</li></ul><br>We also agree to the Individual Redress Principle, which requires that individuals have a right to pursue legally enforceable rights against data collectors and processors who fail to adhere to the law. This principle requires not only that individuals have enforceable rights against data users, but also that individuals have recourse to courts or government agencies to investigate and/or prosecute non-compliance by data processors.<br>CAN SPAM Act<br>The CAN-SPAM Act is a law that sets the rules for commercial email, establishes requirements for commercial messages, gives recipients the right to have emails stopped from being sent to them, and spells out tough penalties for violations.<br><ul><b>We collect your email address in order to:</b><li>Market to our mailing list or continue to send emails to our clients after the original transaction has occurred.</li></ul><ul><b>To be in accordance with CANSPAM we agree to the following:</b><li>NOT use false or misleading subjects or email addresses.</li><li>Identify the message as an advertisement in some reasonable way.</li><li>Include the physical address of our business or site headquarters.</li><li>Monitor third-party email marketing services for compliance, if one is used.</li><li>Honor opt-out/unsubscribe requests quickly.</li><li>Allow users to unsubscribe by using the link at the bottom of each email.</li></ul><ul><b>If at any time you would like to unsubscribe from receiving future emails, you can email us at</b><li>Follow the instructions at the bottom of each email. and we will promptly remove you from ALL correspondence.</li></ul><br>Contacting Us<br><br><hr><button class=submit-button data-ui-sref=contact><b>If there are any questions regarding this privacy policy you may contact us here.</b></button><hr><i>Last Edited on 2016-06-18</i></div>"),$templateCache.put("partials/social.html",'<div data-twitter-feed></div><div data-ng-if=false id=Network><br><button style=background-color:#3A5795;width:100% data-ng-click="should_display = !should_display" class="btn btn-default">FaceBook</button> <button style=background-color:#125688;width:100% data-ng-click="artist = !artist" class="btn btn-default">Instagram<div data-ng-if=artist data-instagram></div></button> <button style=background-color:#59ADEB;width:100% data-ng-click="should_display_tweet = !should_display_tweet" class="btn btn-default">Twitter</button> <a style=background-color:#F0242A;width:100% href=http://www.soundclick.com/DrVamp target=_blank class="btn btn-default">Itunes</a> <a style=background-color:#ff3e00;width:100% data-ng-click="should_display = !should_display" class="btn btn-default">SoundCloud</a> <a style=background-color:#fafafa;width:100% href=http://www.soundclick.com/DrVamp target=_blank class="btn btn-default">SoundClick</a> <a style=background-color:#fafafa;width:100% href=http://www.splice.com/DrVamp target=_blank class="btn btn-default">Splice.com</a> <a style=background-color:#1DD65F;width:100% href=http://www.soundclick.com/DrVamp target=_blank class="btn btn-default">Spotify</a><div data-ng-if="should_display === true"><iframe width=100% height=150 scrolling=no frameborder=no src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/148558617&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe><iframe width=100% height=150 scrolling=no frameborder=no src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/113326521&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe><iframe width=100% height=150 scrolling=no frameborder=no src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/110627228&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe></div><div id=container data-ng-if="should_display_tweet === true"><div data-twitter-feed></div></div></div>'),$templateCache.put("directive/artist-api.html",'<div><div class=artist-search-container><fieldset><select class=form-control data-ng-options="e.search for e in engine" data-ng-model=selected></select></fieldset><div data-type=selected.search data-artist-content></div></div><ul data-ng-repeat="artist in artists"><img width=20 height=20 data-ng-src={{artist.images.low_resolution.url}}></ul></div>'),$templateCache.put("directive/artist-content/artist-content.html",'<div id=ArtistContent><input autofocus data-ng-model-options="{ debounce: 500 }" data-ng-model=model.artist class="form-control text-input" data-ng-change=searchArtist($event)><br><div class=list-container data-ng-repeat="item in model.items"><b class=text>Album:</b><br><span class="text span" ng-bind=item.name></span><br><img class=album-img data-ng-if="item && item.images[0].url" data-ng-src={{item.images[0].url}}></div><div class=list-container data-ng-repeat="item in model.toptracks"><b class=text>Title:</b><br><span class="text span" ng-bind=item.name></span><br><img class=album-img data-ng-src="{{ item.image[3].url }}"> <a data-ng-if=item.url target=_blank data-ng-href={{item.url}}>See on LastFm</a></div></div>'),$templateCache.put("directive/footer/home-footer.html",'<footer class=footer><button class=nav-button data-ng-repeat="item in items" data-ui-state="item.to_state || \'home\'" data-ui-state="item.state || \'\'" data-ui-sref-active=active data-ng-click="" data-ng-bind=::item.title></button> <img class=footer-wave-image src=images/hip-hop-2014.png width=80px height=30px;></footer>'),$templateCache.put("directive/gear/gear.html",'<div id=Slide><div class="studio-gear fade-in fade-out" data-ng-if=model.should_display data-ng-swipe-left="onButtonClicked(\'left\')" data-ng-swipe-right="onButtonClicked(\'right\')"><button data-ng-click="onButtonClicked(\'left\')" class="direction fa fa-arrow-left"></button><div class=content data-ng-if=model.should_display><img data-ng-src={{model.item.image}} class=gear-image><div class=text data-ng-if="model.item.title || model.item.description"><h5 class=item-title data-ng-bind-html=model.item.title></h5><span class=description data-ng-bind-html="model.item.description.join(\'\')"></span></div></div><button data-ng-click="onButtonClicked(\'right\')" class="direction fa fa-arrow-right"></button></div></div>'),$templateCache.put("directive/instagram.html","<div data-ng-if=artist id=Artist data-ng-class=\"{ 'slide-side' : model.should_slide }\"></div>"),$templateCache.put("directive/nav-bar/nav-bar.html",'<div id=NavBar><button class="menu-tab nav-button" data-ng-repeat="item in menu_bar" data-ng-attr-tabindex={{item.index}} data-ng-keyup=onKeyUp($event) data-focus-if=is_current_state data-ui-state="item.state || \'\'" data-ui-sref-active=active data-ng-click="" data-ng-bind-html=::item.title></button></div>'),$templateCache.put("directive/overlay/loading.html",'<div data-ng-if=window.is_loading id=ContainerOverlay><div class=loading><div class=sk-cube-grid><div class="sk-cube sk-cube1"></div><div class="sk-cube sk-cube2"></div><div class="sk-cube sk-cube3"></div><div class="sk-cube sk-cube4"></div><div class="sk-cube sk-cube5"></div><div class="sk-cube sk-cube6"></div><div class="sk-cube sk-cube7"></div><div class="sk-cube sk-cube8"></div><div class="sk-cube sk-cube9"></div></div></div></div>'),$templateCache.put("directive/playlist/playlist.html",'<div id=table-list><div id=mp3_player><div id=audio_box><audio id=audioplayer data-ng-src="{{model.source | trusted}}" controls loop>Your browser does not support the audio tag.</audio></div><canvas class=canvas id=analyser_render></canvas></div><div class=table-list ng-init="show = true" data-ng-show=show><ul class=playlist><li data-ng-repeat="track in tracks" data-ng-class="{ \'active\' : model.playing_item.index === $index } "><div class="play-controls fa" data-ng-class="model.playing_item.index === $index ? \'fa-pause\' : \'fa-play-circle-o\' " data-ng-click="onPlayToggle($event, $index)"></div><div class=vertical-divider></div><div class=track-info-container><a class=track-name data-ng-click="onPlayToggle($event, $index)">{{track.name}}</a><div ng-if="track.waveform && model.playing_item.index === $index" class=overlay-wave></div><img class=waveform data-ng-src={{track.waveform}} data-ng-if=track.waveform></div></li></ul></div></div>'),$templateCache.put("directive/rss-feed/rss-feed.html",'<div id=RssFeed class="fade-in fade-out" data-ng-if="model.feed && model.should_display"><button data-ng-click="onButtonClicked(\'left\')" data-ng-if=!model.is_mobile class="direction fa fa-arrow-left"></button><div class=indicators><div class=indicator ng-repeat="indicator in model.slides" id={{$index}} data-ng-class="{\'active\': model.active_slide_index === $index }" data-ng-click=onIndicatorClicked($index) data-ng-bind=$index></div></div><hr><data-social-share></data-social-share><div class=content data-ng-swipe-left="onButtonClicked(\'right\')" data-ng-swipe-right="onButtonClicked(\'left\')"><div class=date data-ng-bind=model.feed.publishedDate></div><br><img data-ng-if=model.image_thumbnail class=image-thumbnail width=360 height=240 data-ng-src="{{model.image_thumbnail}}"><br><a data-ng-click="" class=title data-ng-href={{model.feed.link}} target=_blank>{{model.feed.title}}</a><br><p class="contentSnippet fade-in fade-out" data-ng-bind-html=model.feed.content></p><br></div><button data-ng-click="onButtonClicked(\'right\')" data-ng-if=!model.is_mobile class="direction fa fa-arrow-right"></button></div>'),
$templateCache.put("directive/rss-ribbon/rss-ribbon.html","<div id=RSS_Ribbon><div class=\"content {{ '--' + $index + '--' }}\" data-ng-swipe-left=\"onButtonClicked('right')\" data-ng-swipe-right=\"onButtonClicked('left')\" ng-repeat=\"feed in feeds\"><div class=\"{{ '--' + $index + '--' }}\" rss-tile item=feed></div></div></div>"),$templateCache.put("directive/social-share/social-share.html",'<div id=SocialShare><a class="share-social-icon twitter-share-button" data-ng-if=model.should_show href="https://twitter.com/intent/tweet?text= {{parent_model.feed.title | cut:true:50:\' ...\'}}&url={{parent_model.state | escape}}&hashtags=drvamp,drvaudio" data-show-count=true><img src=http://res.cloudinary.com/www-drvaudio-com/image/upload/c_scale,w_50/v1473823868/twitter_mcrbon.png alt="Share on Twitter"></a> <a class=share-social-icon data-ng-click=onFbClick() data-ng-if=model.should_show><img src=http://res.cloudinary.com/www-drvaudio-com/image/upload/c_scale,w_50/v1473884393/fb_vyvgsx.png></a></div>'),$templateCache.put("directive/soundcloud/soundcloud-new-track.html",'<div id=Soundcloud data-ng-if="!$state.is(\'home.artist\')"><iframe scrolling=no frameborder=no src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/260479548&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=false"></iframe></div>'),$templateCache.put("directive/twitter/twitter-feed.html","<twitter-widget data-ng-if=\"!$state.is('home.artist')\"><a class=twitter-timeline href=https://twitter.com/DktrVamp data-widget-id=693361144551968770>Tweets by Dr.Vamp</a><script src=libs/twitter.js></script></twitter-widget>"),$templateCache.put("directive/vertical-menu/vertical-menu.html",'<div class=vertical-menu data-ng-class="{ \'is-closed\' : !model.is_open }"><i class="nav-indicator fade-in fade-out fa" data-ng-if=model.show_indicator data-ng-click=onOpenClose($event) data-ng-attr-title="{{model.is_open ? \'Close\' : \'Open\'}}" data-ng-mouseover="model.show_tool_tip = true" data-ng-mouseleave="model.show_tool_tip = false" data-ng-class="{\n            \'fa-bars\' : !model.is_open,\n            \'fa-times-circle-o\' : model.is_open\n        }"></i><br><div class=content data-ng-if=model.is_open><h3 class=nav-header data-ng-bind=::model.title></h3><button class="action-btn btn" data-ng-repeat="tab in model.tabs | orderBy : \'title\'" data-ng-click="onClicked($event, tab)" data-ng-bind=::tab.title></button><hr><button class="action-btn btn direction-btn bottom" data-ng-click="onClicked($event); onOpenClose($event)">Search For An Artist</button></div></div>'),$templateCache.put("directive/visual-animation/wave.html","<div id=Bars><div data-ng-repeat=\"bar in bars\" class=bar data-ng-style=\"{\n            'background' : bar.color,\n            'animation-delay' : bar.delay + 's',\n            '-webkit-animation-delay' : bar.delay + 's',\n            '-o-animation-delay' : bar.delay + 's',\n            '-moz-animation-delay' : bar.delay + 's'\n        }\"></div></div>"),$templateCache.put("modals/confirmation.html",'<div class=modal-confirmation><h3>Your email was sent!</h3><br><h4>Your Email: <a href=#>{{$parent.model.email}}</a></h4><br><h5>Thank You, <b>{{$parent.model.name}}</b></h5><br><h5>Have a nice day!</h5><br><hr><button class="nav-button active" data-ui-sref=home>Home Page</button></div>'),$templateCache.put("modals/gear.html",'<div class=gear-container><span class="fa fa-times-circle" data-ng-click=onClose()></span> <img class=image data-ng-repeat="img in model.image" data-ng-src="{{ img }}"><br><hr><div class=text-container data-ng-repeat="con in model.content track by $index"><span class=text data-ng-bind-html=con></span></div></div>'),$templateCache.put("modals/purchase-modal.html",'<div class=purchase-dialog><button class="close-button fa-stack" data-ng-click=onDismiss()><span class="fa fa-square fa-stack-2x"></span> <span class="fa fa-times fa-stack-1x"></span></button></div>')}]);